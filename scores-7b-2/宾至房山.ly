...
4/4
1' 0 0 0
5 - 0 0 | q2 q3 0 0 0 | s1 s2 0 0 0 q0 | d1 d2 0 0 0 q0. | - 0 0 0 |
2' - 1 6
1 0 - 0 | - 0 0 0 | q2 q3 0 0 0 | s1 s2 0 0 0 q0 | d1 d2 0 0 0 q0. | - 0 0 0 |
1 7 - 0 | - 0 0 0 | q4 q1' 0 0 0 | s1 s2 0 0 0 q0 | d1 d2 0 0 0 q0. | - 0 0 0 |
5 0 0 0
1' 0 0 0 | q2 q3 0 0 0 | s1 s2 0 0 0 q0 | d1 d2 0 0 0 q0. | - 0 0 0 |
6 0 0 0
1 0 - 0 | q2 q3 0 0 0 | s1 s2 0 0 0 q0 | 7 - 0 0 | - 0 0 0 |
1' - 0 0 | q4 q1' 0 0 0 | s1 s2 0 0 0 q0 | - - 0 0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 c''4 r2. | %{ bar 2: %} g'2 r2 | | %{ bar 3: %} d'8 e'8 r2. | | %{ bar 4: %} c'16 d'16 r2. r8 | | %{ bar 5: %} c'32 d'32 r2. r8. | | %{ bar 6: %} R1 | | %{ bar 7: %} d''2 c'4 a'4 | %{ bar 8: %} c'4 r2. | | %{ bar 9: %} R1 | | %{ bar 10: %} d'8 e'8 r2. | | %{ bar 11: %} c'16 d'16 r2. r8 | | %{ bar 12: %} c'32 d'32 r2. r8. | | %{ bar 13: %} R1 | | %{ bar 14: %} c'4 b'2 r4 | | %{ bar 15: %} R1 | | %{ bar 16: %} f'8 c''8 r2. | | %{ bar 17: %} c'16 d'16 r2. r8 | | %{ bar 18: %} c'32 d'32 r2. r8. | | %{ bar 19: %} R1 | | %{ bar 20: %} g'4 r2. | %{ bar 21: %} c''4 r2. | | %{ bar 22: %} d'8 e'8 r2. | | %{ bar 23: %} c'16 d'16 r2. r8 | | %{ bar 24: %} c'32 d'32 r2. r8. | | %{ bar 25: %} R1 | | %{ bar 26: %} a'4 r2. | %{ bar 27: %} c'4 r2. | | %{ bar 28: %} d'8 e'8 r2. | | %{ bar 29: %} c'16 d'16 r2. r8 | | %{ bar 30: %} b'2 r2 | | %{ bar 31: %} R1 | | %{ bar 32: %} c''2 r2 | | %{ bar 33: %} f'8 c''8 r2. | | %{ bar 34: %} c'16 d'16 r2. r8 | | %{ bar 35: %} R1 | | %{ bar 36: %} r1 | } }
% === END MIDI STAFF ===
