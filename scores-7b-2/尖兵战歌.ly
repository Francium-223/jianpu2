...
4/4
6 - 7 0 | q2 - q3 0 0 | s1' - s2' 0 0 q0 | d5 - 1' 0 q0. d0 | 0 0 0 0 |
q2 - q3 0 0 | s1' - s2' 0 0 q0 | d5 - 1' 0 q0. d0 | 0 0 0 0 |
q2 - q3 0 0 | s1' - s2' 0 0 q0 | d5 - 1' 0 q0. d0 | 0 0 0 0 |
%END
%}
...
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 12: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #3
 \note-mod "5" g'32[
]  ~  \note-mod "–" g'4  \note-mod "1" c''4^.  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'2 b'4 r4 | | %{ bar 2: %} d'8  ~ d'4 e'8 r2 | | %{ bar 3: %} c''16  ~ c''4 d''16 r2 r8 | | %{ bar 4: %} g'32  ~ g'4 c''4 r4 r8. r32 | | %{ bar 5: %} R1 | | %{ bar 6: %} d'8  ~ d'4 e'8 r2 | | %{ bar 7: %} c''16  ~ c''4 d''16 r2 r8 | | %{ bar 8: %} g'32  ~ g'4 c''4 r4 r8. r32 | | %{ bar 9: %} R1 | | %{ bar 10: %} d'8  ~ d'4 e'8 r2 | | %{ bar 11: %} c''16  ~ c''4 d''16 r2 r8 | | %{ bar 12: %} g'32  ~ g'4 c''4 r4 r8. r32 | | %{ bar 13: %} r1 | } }
% === END MIDI STAFF ===
