...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 a'2 | | %{ bar 2: %} R2 | | %{ bar 3: %} b'4 e'8 g'8 | | %{ bar 4: %} R2 | | %{ bar 5: %} e'8 r4 r8 | %{ bar 6: %} R2 | | %{ bar 7: %} c'2 | | %{ bar 8: %} R2 | | %{ bar 9: %} d'4. r8 | | %{ bar 10: %} R2 | | %{ bar 11: %} R2 | | | %{ bar 12: %} d'2 | | %{ bar 13: %} R2 | | %{ bar 14: %} c'2 | | %{ bar 15: %} R2 | | %{ bar 16: %} d'2 | | %{ bar 17: %} R2 | | %{ bar 18: %} R2 | | %{ bar 19: %} e'4. r8 | | %{ bar 20: %} R2 | | %{ bar 21: %} R2 | | %{ bar 22: %} d'4. r8 | %{ bar 23: %} e'4. r8 | %{ bar 24: %} f'4 r4 | %{ bar 25: %} g4 r4 } }
% === END MIDI STAFF ===
