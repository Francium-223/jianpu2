...
4/4
3 q2 s0 - - s0 | - - - - | - - 1. q0 | 5 0 0 0
6 q2 q7 q1' q2' q1 q0 | 0 q1 1 q1 2 | q1 3 q1 4 q1 q0 | 5 0 0 0
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'4 d'8 r16 r2 r16 | | %{ bar 2: %} R1 | | %{ bar 3: %} r2 c'4. r8 | | %{ bar 4: %} g'4 r2. | %{ bar 5: %} a'4 d'8 b'8 c''8 d''8 c'8 r8 | | %{ bar 6: %} r4 c'8 c'4 c'8 d'4 | | %{ bar 7: %} c'8 e'4 c'8 f'4 c'8 r8 | | %{ bar 8: %} g'4 r2. } }
% === END MIDI STAFF ===
