...
6 - 7 - | 1' - 2' - | 0 - 3 4 | - 5 - 2 | - 3 0 0 | - 0 0 0 | 0 0 0 0 |
R{ } A{ | | } R{ }
1' q1 q1 q1 q1 q1 q1 | q1 q1 q1 q1 q1 0 q0
q1. q1. 0 0 q0
q1 s1 d1 0 q2 - q0 d0 | 3 q4 0 0 q0 | 0 0 0 0 |
R{ } A{ | | } R{ }
6' - - 0
7' 0 0 0
1'' 0 0 0
...
%% === BEGIN JIANPU STAFF ===
 ...
 ~  \note-mod "–" b'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 2: %}
 \note-mod "1" c''4^.
...
\=JianpuTie(  ~ | | %{ bar 5: %}
 ...
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 7: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \repeat volta 3 { } \alternative { { } { } { }} \repeat volta 2 { } | %{ bar 8: %}
 \note-mod "1" c''4^.
...
| | %{ bar 13: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \repeat volta 3 { } \alternative { { } { } { }} \repeat volta 2 { } \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 14: %}
 \note-mod "6" a''4^.
 ~ \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "–" a''4
 ~  \note-mod "–" a''4  \note-mod "0" r4 | %{ bar 15: %}
 \note-mod "7" b''4^.
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | %{ bar 16: %}
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "1" c'''4-\tweak #'X-offset #0.6 ^\two-dots 
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | %{ bar 17: %}
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "2" d'''4-\tweak #'X-offset #0.6 ^\two-dots 
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | %{ bar 18: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | %{ bar 19: %}
 \note-mod "3" e'4
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { a'2 b'2 | | %{ bar 2: %} c''2 d''2 | | %{ bar 3: %} r2 e'4 f'4  ~ | | %{ bar 4: %} f'4 g'2 d'4  ~ | | %{ bar 5: %} d'4 e'4 r2 | | %{ bar 6: %} R1 | | %{ bar 7: %} r1 | \repeat volta 3 { } \alternative { { } { } { }} \repeat volta 2 { } | %{ bar 8: %} c''4 c'8 c'8 c'8 c'8 c'8 c'8 | | %{ bar 9: %} c'8 c'8 c'8 c'8 c'8 r4 r8 | %{ bar 10: %} c'8. c'8. r2 r8 | %{ bar 11: %} c'8 c'16 c'32 r4 d'8  ~ d'4 r8 r32 | | %{ bar 12: %} e'4 f'8 r2 r8 | | %{ bar 13: %} r1 | \repeat volta 3 { } \alternative { { } { } { }} \repeat volta 2 { } | %{ bar 14: %} a''2. r4 | %{ bar 15: %} b''4 r2. | %{ bar 16: %} c'''4 r2. | %{ bar 17: %} d'''4 r2. | %{ bar 18: %} R1 | %{ bar 19: %} e'4 r2. } }
% === END MIDI STAFF ===
