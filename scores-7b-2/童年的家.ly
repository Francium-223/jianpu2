...
4/4
6 - 3 0 | q5 q2 - 0 0 | 0 0 0 0 |
q7 q1' q2' q1 0 q1 q0 | 1 q1 2 q1 3 | q1 4 q1 5 q1 q0 | 6 0 0 0 | 0 0 0 0 |
R{ } A{ }
subtitle=童年的家
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'2 e'4 r4 | | %{ bar 2: %} g'8 d'8  ~ d'4 r2 | | %{ bar 3: %} R1 | | %{ bar 4: %} b'8 c''8 d''8 c'8 r4 c'8 r8 | | %{ bar 5: %} c'4 c'8 d'4 c'8 e'4 | | %{ bar 6: %} c'8 f'4 c'8 g'4 c'8 r8 | | %{ bar 7: %} a'4 r2. | | %{ bar 8: %} r1 | \repeat volta 2 { } \alternative { { }} } }
% === END MIDI STAFF ===
