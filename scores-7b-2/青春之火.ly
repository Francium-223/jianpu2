...
4/4
6 - 3 2 | q3 q3 q3 0 0 q0 | 0 0 0 0 |
0 0 0 0 | q3 q3 q3 0 0 q0 | 0 0 0 0 |
R{ 0 0 0 0 | 0 } 0 0 0 |
subtitle=intro
%END
%}
...
%% === BEGIN JIANPU STAFF ===
 ...
 ~  \note-mod "–" a'4  \note-mod "3" e'4  \note-mod "2" d'4 | | %{ bar 2: %} \set stemLeftBeamCount = #0
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'2 e'4 d'4 | | %{ bar 2: %} e'8 e'8 e'8 r2 r8 | | %{ bar 3: %} R1 | | %{ bar 4: %} R1 | | %{ bar 5: %} e'8 e'8 e'8 r2 r8 | | %{ bar 6: %} r1 | \repeat volta 2 { | %{ bar 7: %} R1 | | %{ bar 8: %} r4 } r2. | } }
% === END MIDI STAFF ===
