...
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
\repeat volta 2 { } \alternative { { } { }} | %{ bar 19: %}
 \note-mod "1" c'4
 \note-mod "2" d'4 \bar "|." } }
% === END JIANPU STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 a'2 | | %{ bar 2: %} R2 | | %{ bar 3: %} g'4 e'8 r8 | | %{ bar 4: %} R2 | | %{ bar 5: %} b'8 r4 r8 | %{ bar 6: %} a'2 | | %{ bar 7: %} R2 | | %{ bar 8: %} R2 | | %{ bar 9: %} R2 | | %{ bar 10: %} c'4 r4 | | %{ bar 11: %} R2 | | %{ bar 12: %} d'4 r4 | | %{ bar 13: %} R2 | | %{ bar 14: %} e'4. r8 | | %{ bar 15: %} R2 | %{ bar 16: %} a'4. r8 | %{ bar 17: %} a'4. r8 | %{ bar 18: %} a'4. r8 \repeat volta 2 { } \alternative { { } { }} | %{ bar 19: %} c'4 d'4 } }
% === END MIDI STAFF ===
