...
4/4
0 q2 0 0 q0 | 0 0 0 0 |
3 5 q7 0 q0 | 6 - 6 0 | 1 - q1' 0 q0 | 0 0 0 0 |
1 2 3 0 | 0 0 0 0 |
|
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 d'8 r2 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} e'4 g'4 b'8 r4 r8 | | %{ bar 4: %} a'2 a'4 r4 | | %{ bar 5: %} c'2 c''8 r4 r8 | | %{ bar 6: %} R1 | | %{ bar 7: %} c'4 d'4 e'4 r4 | | %{ bar 8: %} r1 | | } }
% === END MIDI STAFF ===
