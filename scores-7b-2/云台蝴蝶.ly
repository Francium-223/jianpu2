...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'4 e'4 d'8 r4 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} a'4 b'8 c''8 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} d''2. r4 | | %{ bar 6: %} c'4 b'4 d'4 r4 | %{ bar 7: %} d'8 r2. r8 | | %{ bar 8: %} R1 | | %{ bar 9: %} a'4 b'8 c''8 r2 | | %{ bar 10: %} R1 | | %{ bar 11: %} d''2. r4 } }
% === END MIDI STAFF ===
