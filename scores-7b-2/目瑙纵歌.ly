...
4/4
5 - q3 s2 d6 q7 q1' d0 | q2' q0 q1 q2 q3 q4 q5 q6 | q7 q1' q2' q0 q1 q2 q3 q4 | q5 q6 q7 q1' q2' 0 q0
q0 q1 q2 q3 q4 q5 q6 q7 | q1' q2' q0 q1 q2 q3 q4 q5 | q6 q7 q1' q2' 0 0
R{ 5 0 0 0 | } 0 0 0 0 |
%END
%}
...
\set stemRightBeamCount = #1
 \note-mod "2" d''8^.]
 \note-mod "0" r4  \note-mod "0" r4 \repeat volta 2 { | %{ bar 8: %}
 \note-mod "5" g'4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | } | %{ bar 9: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \bar "|." } }
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'2 e'8 d'16 a'32 b'8 c''8 r32 | | %{ bar 2: %} d''8 r8 c'8 d'8 e'8 f'8 g'8 a'8 | | %{ bar 3: %} b'8 c''8 d''8 r8 c'8 d'8 e'8 f'8 | | %{ bar 4: %} g'8 a'8 b'8 c''8 d''8 r4 r8 | %{ bar 5: %} r8 c'8 d'8 e'8 f'8 g'8 a'8 b'8 | | %{ bar 6: %} c''8 d''8 r8 c'8 d'8 e'8 f'8 g'8 | | %{ bar 7: %} a'8 b'8 c''8 d''8 r2 \repeat volta 2 { | %{ bar 8: %} g'4 r2. | } | %{ bar 9: %} r1 | } }
% === END MIDI STAFF ===
