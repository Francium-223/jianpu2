...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'2 r2 | | %{ bar 2: %} R1 | | %{ bar 3: %} r4 e'4 g'4 r4 | | %{ bar 4: %} R1 | | %{ bar 5: %} R1 | | %{ bar 6: %} d'2 r2 | | %{ bar 7: %} R1 | | %{ bar 8: %} c'4. r2 r8 | %{ bar 9: %} a'4 b'4 c''4 d'8. r16 | %{ bar 10: %} c''2 r2 | %{ bar 11: %} a'4 c''4 r2 | | %{ bar 12: %} R1 | | %{ bar 13: %} d'8. r2. r16 } }
% === END MIDI STAFF ===
