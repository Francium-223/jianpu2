...
6 - 0 7 | 2 3 4 5 | 1' - 0 0 | 2' 1' 0 0 | 0 0 0 0 |
%END
%}
...
%% === BEGIN JIANPU STAFF ===
 ...
 ~  \note-mod "–" a'4  \note-mod "0" r4  \note-mod "7" b'4 | | %{ bar 2: %}
 \note-mod "2" d'4
 \note-mod "3" e'4  \note-mod "4" f'4  \note-mod "5" g'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 3: %}
 \note-mod "1" c''4^.
 ~  \note-mod "–" c''4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 4: %}
 \note-mod "2" d''4^.
 \note-mod "1" c''4^.  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 5: %}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { a'2 r4 b'4 | | %{ bar 2: %} d'4 e'4 f'4 g'4 | | %{ bar 3: %} c''2 r2 | | %{ bar 4: %} d''4 c''4 r2 | | %{ bar 5: %} r1 | } }
% === END MIDI STAFF ===
