...
4/4
3 6 0 q2 q0 | - 0 0 0 | 0 0 0 0 |
7 7 7 - | 0 0 0 0 |
3 6 0 q1 q0
7 7 7 2 | 5 6 - 0
3 6 0 0 | 0 0 0 0 |
7 7 7 2 | 2 3 2 0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'4 a'4 r4 d'8 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} R1 | | %{ bar 4: %} b'4 b'4 b'2 | | %{ bar 5: %} R1 | | %{ bar 6: %} e'4 a'4 r4 c'8 r8 | %{ bar 7: %} b'4 b'4 b'4 d'4 | | %{ bar 8: %} g'4 a'2 r4 | %{ bar 9: %} e'4 a'4 r2 | | %{ bar 10: %} R1 | | %{ bar 11: %} b'4 b'4 b'4 d'4 | | %{ bar 12: %} d'4 e'4 d'4 r4 | | %{ bar 13: %} r1 | } }
% === END MIDI STAFF ===
