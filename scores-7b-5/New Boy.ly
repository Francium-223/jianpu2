...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r2 d'8 e'8 r4 | | %{ bar 2: %} R1 | | %{ bar 3: %} a'8 b'4 g'4 g'4 r8 | | %{ bar 4: %} e'4 d'4 r2 | | %{ bar 5: %} e'4 e'4 r2 | | %{ bar 6: %} e'4 r2. | %{ bar 7: %} e'4 r2. | %{ bar 8: %} e'4 r2. | %{ bar 9: %} e'4 r2. | %{ bar 10: %} e'4 r2. | %{ bar 11: %} e'4 r2. | %{ bar 12: %} e'4 r2. | %{ bar 13: %} r4 d'8 c'8 r2 | | %{ bar 14: %} R1 | | %{ bar 15: %} a'8 b'4 g'4 f'4 r8 | | %{ bar 16: %} R1 | | %{ bar 17: %} R1 | | %{ bar 18: %} R1 | | %{ bar 19: %} r1 | } }
% === END MIDI STAFF ===
