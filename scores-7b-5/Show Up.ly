...
4/4
6 - 7 q2 q0 | 0 0 0 0 |
q5 q3 q2 - 0 q0 | 0 0 0 0 |
q5 q1 q0 q1' q2' q1 0 | q1 1 q1 2 q1 q0 | 3 q1 4 q1 5 | q1 6 0 0 q0 | 0 0 0 0 |
R{ }
%END
%}
...
\set stemRightBeamCount = #1
 \note-mod "1" c'8[]
 \note-mod "5" g'4 | | %{ bar 8: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]   \note-mod "6" a'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'2 b'4 d'8 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} g'8 e'8 d'8  ~ d'4 r4 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} g'8 c'8 r8 c''8 d''8 c'8 r4 | | %{ bar 6: %} c'8 c'4 c'8 d'4 c'8 r8 | | %{ bar 7: %} e'4 c'8 f'4 c'8 g'4 | | %{ bar 8: %} c'8 a'4 r2 r8 | | %{ bar 9: %} r1 | \repeat volta 2 { } } }
% === END MIDI STAFF ===
