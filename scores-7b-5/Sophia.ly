...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.Stem.transparent = ##t
     \time 4/4  \note-mod "3" e'4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 \set stemLeftBeamCount = #0
...
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
\repeat volta 2 { | } \alternative { { } { }} | %{ bar 5: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8.[
]   \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #2
 \note-mod "0" c'16[]
\repeat volta 2 { | } \alternative { { } { }} | %{ bar 6: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "5" g'8.[
]   \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #2
 \note-mod "0" c'16[]
\repeat volta 2 { | } \alternative { { } { }} | %{ bar 7: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "7" b'8.[
]   \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #2
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'4 a'8  ~ a'4 r4 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} R1 | | %{ bar 4: %} d'8 r2. r8 \repeat volta 2 { | } \alternative { { } { }} | %{ bar 5: %} c'8. r2. r16 \repeat volta 2 { | } \alternative { { } { }} | %{ bar 6: %} g'8. r2. r16 \repeat volta 2 { | } \alternative { { } { }} | %{ bar 7: %} b'8. r2. r16 | %{ bar 8: %} R1 | %{ bar 9: %} c''8  ~ c''4 r2 r8 | %{ bar 10: %} d''8. r2. r16 | | %{ bar 11: %} a'8  ~ a'4 r2 r8 | | %{ bar 12: %} e'8 d'8 r2. | } }
% === END MIDI STAFF ===
