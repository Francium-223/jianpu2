...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 c''4 c''16 c''4 c''4 c''16 r8 | %{ bar 2: %} e'4 d'8 c'16 g'8  ~ g'4 r8. | %{ bar 3: %} a'8 b'8 c''8 d''8 r2 | %{ bar 4: %} c''16 c''16 c''4 c''4 c''16 r4 r16 | %{ bar 5: %} e'4 c'16 c'16 r2 r8 | %{ bar 6: %} f'32  ~ f'4 f'32  ~ f'4 f'32 f'32 r4 r8 | %{ bar 7: %} c''4 c''4 r2 | %{ bar 8: %} c''4 c''4 c''16 c''4 r8. } }
% === END MIDI STAFF ===
