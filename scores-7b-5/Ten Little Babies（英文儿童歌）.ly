...
4/4
subtitle=Ten
q2 q3 s6 d7 q1 - q1 q0 d0 | - 0 0 0 | 0 0 0 0 |
s5 q1' q2' q1 0 q1 q0. | 1 q1 2 q1 3 | q1 4 q1 5 q1 q0 | 6 q1 7 q1 1' | q1 2' q2 0 q2 q0 | 1 q2 2 q2 3 | q2 4 q2 5 q2 q0 | 6 q2 7 q2 1' | 0 0 0 0 |
q2 - 1' - q0 | 0 0 0 0 |
%END
%}
...
\set stemRightBeamCount = #1
 \note-mod "1" c'8[]
 \note-mod "3" e'4 | | %{ bar 6: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
...
\set stemRightBeamCount = #1
 \note-mod "2" d'8[]
 \note-mod "3" e'4 | | %{ bar 10: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "2" d'8[
]   \note-mod "4" f'4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 d'8 e'8 a'16 b'32 c'8  ~ c'4 c'8 r8 r32 | | %{ bar 2: %} R1 | | %{ bar 3: %} R1 | | %{ bar 4: %} g'16 c''8 d''8 c'8 r4 c'8 r8. | | %{ bar 5: %} c'4 c'8 d'4 c'8 e'4 | | %{ bar 6: %} c'8 f'4 c'8 g'4 c'8 r8 | | %{ bar 7: %} a'4 c'8 b'4 c'8 c''4 | | %{ bar 8: %} c'8 d''4 d'8 r4 d'8 r8 | | %{ bar 9: %} c'4 d'8 d'4 d'8 e'4 | | %{ bar 10: %} d'8 f'4 d'8 g'4 d'8 r8 | | %{ bar 11: %} a'4 d'8 b'4 d'8 c''4 | | %{ bar 12: %} R1 | | %{ bar 13: %} d'8  ~ d'4 c''2 r8 | | %{ bar 14: %} r1 | } }
% === END MIDI STAFF ===
