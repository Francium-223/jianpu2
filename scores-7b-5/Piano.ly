...
4/4
0 5 6 1' | - 2 3 1'
q7 q1' q2' q1 0 q1 q0 | 1 q1 2 q1 3 | q1 4 q1 5 q1 q0 | 6 0 0 0
q1 - 0 0 q0
q1 - 0 0 q0
q1 - 0 0 q0
%END
...
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 9: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]  ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 g'4 a'4 c''4  ~ | | %{ bar 2: %} c''4 d'4 e'4 c''4 | %{ bar 3: %} b'8 c''8 d''8 c'8 r4 c'8 r8 | | %{ bar 4: %} c'4 c'8 d'4 c'8 e'4 | | %{ bar 5: %} c'8 f'4 c'8 g'4 c'8 r8 | | %{ bar 6: %} a'4 r2. | %{ bar 7: %} c'8  ~ c'4 r2 r8 | %{ bar 8: %} c'8  ~ c'4 r2 r8 | %{ bar 9: %} c'8  ~ c'4 r2 r8 } }
% === END MIDI STAFF ===
