...
| | %{ bar 4: %}
 ...
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 5: %}
 \note-mod "1" c'4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 \repeat volta 2 { | %{ bar 6: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 } \alternative { { }} \bar "|." } }
% === END JIANPU STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'4 d'8  ~ d'4 r4 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} g'8 a'16 b'32 r2. r32 | | %{ bar 4: %} R1 | | %{ bar 5: %} c'4 r2. \repeat volta 2 { | %{ bar 6: %} r1 } \alternative { { }} } }
% === END MIDI STAFF ===
