...
4/4
0 q2 - 0 q0 | 0 0 0 0 |
3 s5 d6 - 0 q0 d0 | 0 0 0 0 |
q7 q1. 0 0 q0. | 0 0 0 0 |
q2 - 0 0 q0 | 0 0 0 0 |
3 s5 d6 - 0 q0 d0 | 0 0 0 0 |
q7 q1. 0 0 q0. | 0 0 0 0 |
q2 - 0 0 q0 | 0 0 0 0 |
...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.Stem.transparent = ##t
     \time 4/4  \note-mod "0" r4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 \set stemLeftBeamCount = #0
...
\set stemRightBeamCount = #3
 \note-mod "0" r32]
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 27: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "2" d'8[
]  ~  \note-mod "–" d'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
| | %{ bar 28: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 29: %}
 \note-mod "3" e'4
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 d'8  ~ d'4 r4 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} e'4 g'16 a'32  ~ a'4 r4 r8 r32 | | %{ bar 4: %} R1 | | %{ bar 5: %} b'8 c'8. r2 r8. | | %{ bar 6: %} R1 | | %{ bar 7: %} d'8  ~ d'4 r2 r8 | | %{ bar 8: %} R1 | | %{ bar 9: %} e'4 g'16 a'32  ~ a'4 r4 r8 r32 | | %{ bar 10: %} R1 | | %{ bar 11: %} b'8 c'8. r2 r8. | | %{ bar 12: %} R1 | | %{ bar 13: %} d'8  ~ d'4 r2 r8 | | %{ bar 14: %} R1 | | %{ bar 15: %} e'4 g'16 a'32  ~ a'4 r4 r8 r32 | | %{ bar 16: %} R1 | | %{ bar 17: %} b'8 c'8. r2 r8. | | %{ bar 18: %} R1 | | %{ bar 19: %} d'8 r2. r8 | | %{ bar 20: %} R1 | | %{ bar 21: %} e'4 f'4 g'4 a'4  ~ | | %{ bar 22: %} a'4 r2. | %{ bar 23: %} d'8  ~ d'4 r2 r8 | %{ bar 24: %} e'4 g'16 a'2 r8. | %{ bar 25: %} r4 d'8 r2 r8 | %{ bar 26: %} e'4 g'16 a'32  ~ a'4 r4 r8 r32 | %{ bar 27: %} d'8  ~ d'4 r2 r8 | | %{ bar 28: %} R1 | | %{ bar 29: %} e'2 g'16  ~ g'4 r8. | | %{ bar 30: %} R1 | | %{ bar 31: %} r1 | } }
% === END MIDI STAFF ===
