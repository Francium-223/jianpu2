...
4/4
3 - - 0 | q2 q7 q6 q5 0 0 | 0 0 0 0 |
q1' q1 0 q2' q1' 0 | 0 0 0 0 |
3 0 0 0 | q7 q6 q5 0 0 q0 | 0 0 0 0 |
q1' q1 0 q2' q1' 0 | 0 0 0 0 |
3 - 0 0 | - 0 0 0 | q2 q7 q6 q5 0 0 | 0 0 0 0 |
q1' q1 0 q2' q1' 0 | 0 0 0 0 |
3 0 0 0 | q4 q3 q2 q1 0 0 | 0 0 0 0 |
q2 q3 q2 q1 0 0
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'2. r4 | | %{ bar 2: %} d'8 b'8 a'8 g'8 r2 | | %{ bar 3: %} R1 | | %{ bar 4: %} c''8 c'8 r4 d''8 c''8 r4 | | %{ bar 5: %} R1 | | %{ bar 6: %} e'4 r2. | | %{ bar 7: %} b'8 a'8 g'8 r2 r8 | | %{ bar 8: %} R1 | | %{ bar 9: %} c''8 c'8 r4 d''8 c''8 r4 | | %{ bar 10: %} R1 | | %{ bar 11: %} e'2 r2 | | %{ bar 12: %} R1 | | %{ bar 13: %} d'8 b'8 a'8 g'8 r2 | | %{ bar 14: %} R1 | | %{ bar 15: %} c''8 c'8 r4 d''8 c''8 r4 | | %{ bar 16: %} R1 | | %{ bar 17: %} e'4 r2. | | %{ bar 18: %} f'8 e'8 d'8 c'8 r2 | | %{ bar 19: %} R1 | | %{ bar 20: %} d'8 e'8 d'8 c'8 r2 } }
% === END MIDI STAFF ===
