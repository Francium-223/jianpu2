...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.Stem.transparent = ##t
     \time 2/4  \note-mod "0" r4  \note-mod "5" g'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 2: %}
 \note-mod "3" e'4
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 r4 g'4 | | %{ bar 2: %} e'2  ~ | | %{ bar 3: %} e'4 r4 | | %{ bar 4: %} R2 | | %{ bar 5: %} a'8 b'8 r4 | | %{ bar 6: %} ces''4 c'8 r8 | | %{ bar 7: %} R2 | | %{ bar 8: %} d''8 c'8 r4 | | %{ bar 9: %} R2 | | %{ bar 10: %} c'8 c'4 c'8 | | %{ bar 11: %} d'4 r4 | | %{ bar 12: %} R2 | | %{ bar 13: %} c'8 e'4 c'8 | | %{ bar 14: %} f'4 r4 | | %{ bar 15: %} R2 | | %{ bar 16: %} c'8 g'4 c'8 | | %{ bar 17: %} a'4 r4 | | %{ bar 18: %} R2 | | %{ bar 19: %} c'8 b'4 c'8 | | %{ bar 20: %} c''4 r4 | | %{ bar 21: %} r2 | } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { c'8 d''4 d'8 | r2 | | %{ bar 2: %} r2 | d'8 c'4 d'8 | | %{ bar 3: %} d'4 r4 | r2 | } }
% === END MIDI STAFF ===
