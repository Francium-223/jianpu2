...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 6/8 g'4 f'8 r4 r8 | | %{ bar 2: %} R2. | | %{ bar 3: %} b'4 d'8 e'8 r4 | | %{ bar 4: %} R2. | | %{ bar 5: %} r8 d'2 r8 | | %{ bar 6: %} R2. | | %{ bar 7: %} c'4. g'4 f'8 | | %{ bar 8: %} R2. | | %{ bar 9: %} b'4 d'8 e'8 r4 | | %{ bar 10: %} R2. | | %{ bar 11: %} c''4 r2 \repeat volta 2 { } } }
% === END MIDI STAFF ===
