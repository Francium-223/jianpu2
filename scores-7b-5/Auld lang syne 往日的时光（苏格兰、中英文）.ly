...
4/4
5 - q2 0 q0 | 0 0 0 0 |
q3 q7 s6 1' 0 q0. | 0 0 0 0 |
s1 0 q2' q1' 0 q0. | 0 0 0 0 |
R{ } A{ q7 q6 q5 0 0 q0 }
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'2 d'8 r4 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} e'8 b'8 a'16 c''4 r4 r8. | | %{ bar 4: %} R1 | | %{ bar 5: %} c'16 r4 d''8 c''8 r4 r8. | | %{ bar 6: %} r1 | \repeat volta 2 { } \alternative { { | %{ bar 7: %} b'8 a'8 g'8 r2 r8 }} } }
% === END MIDI STAFF ===
