...
4/4
0 5 0 0 | 3 q2 q7 q6 q1 - |
3 s1' d2' q2 q1 - q0 d0 | 0 0 0 0 |
q2 q1 q1 q1 q1 q1 q1 q1 | q1 q1 q1 q1 q1 q1 q1 q1 | q1 q1 0 0 0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 g'4 r2 | | %{ bar 2: %} e'4 d'8 b'8 a'8 c'8  ~ c'4 | | %{ bar 3: %} e'4 c''16 d''32 d'8 c'8  ~ c'4 r8 r32 | | %{ bar 4: %} R1 | | %{ bar 5: %} d'8 c'8 c'8 c'8 c'8 c'8 c'8 c'8 | | %{ bar 6: %} c'8 c'8 c'8 c'8 c'8 c'8 c'8 c'8 | | %{ bar 7: %} c'8 c'8 r2. | | %{ bar 8: %} r1 | } }
% === END MIDI STAFF ===
