...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 d'8 r2 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} e'8  ~ e'4 r2 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} g'8 r2. r8 | %{ bar 6: %} c'4 a'8 r2 r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} b'16 c''16 r2. r8 | | %{ bar 9: %} R1 | | %{ bar 10: %} R1 | | %{ bar 11: %} R1 | | %{ bar 12: %} R1 | | %{ bar 13: %} R1 | | %{ bar 14: %} r4 d'8 r2 r8 | | %{ bar 15: %} R1 | | %{ bar 16: %} e'8  ~ e'4 r2 r8 | | %{ bar 17: %} R1 | | %{ bar 18: %} g'8 r2. r8 | | %{ bar 19: %} r1 | } }
% === END MIDI STAFF ===
