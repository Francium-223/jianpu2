...
4/4
2 - q3 s6 d7 q5 q4 d0 | q1' q2' q1 0 q1 1 | q1 2 q1 3 q1 q0 | 4 q1 5 q1 6 | q1 7 q1 1' q1 q0 | 2' q2 0 q2 1 | q2 2 q2 3 q2 q0 | 4 0 0 0
q2 3 - - q0 | - - - - | - - - - | - - - - | - 0 0 0
R{ }
%END
%}
...
\set stemRightBeamCount = #1
 \note-mod "1" c'8[]
 \note-mod "6" a'4 | | %{ bar 5: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 d'2 e'8 a'16 b'32 g'8 f'8 r32 | | %{ bar 2: %} c''8 d''8 c'8 r4 c'8 c'4 | | %{ bar 3: %} c'8 d'4 c'8 e'4 c'8 r8 | | %{ bar 4: %} f'4 c'8 g'4 c'8 a'4 | | %{ bar 5: %} c'8 b'4 c'8 c''4 c'8 r8 | | %{ bar 6: %} d''4 d'8 r4 d'8 c'4 | | %{ bar 7: %} d'8 d'4 d'8 e'4 d'8 r8 | | %{ bar 8: %} f'4 r2. | %{ bar 9: %} d'8 e'2. r8 | | %{ bar 10: %} R1 | | %{ bar 11: %} R1 | | %{ bar 12: %} R1 | | %{ bar 13: %} r1 \repeat volta 2 { } } }
% === END MIDI STAFF ===
