...
4/4
3 1' q6 d3 b2 s0. | 7 5 0 0 | 0 0 0 0 |
q3 1' 6 - q0 | - 0 1 7 | 1' 2 3 - | 0 0 0 0 |
5 3 4 0 | 5. 3 0 q0 | 0 0 0 0 |
- - 0 1 | 7 1' 2 3 | - 0 0 0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'4 c''4 a'8 e'32 des'4 r16. | | %{ bar 2: %} b'4 g'4 r2 | | %{ bar 3: %} R1 | | %{ bar 4: %} e'8 c''4 a'2 r8 | | %{ bar 5: %} r2 c'4 b'4 | | %{ bar 6: %} c''4 d'4 e'2 | | %{ bar 7: %} R1 | | %{ bar 8: %} g'4 e'4 f'4 r4 | | %{ bar 9: %} g'4. e'4 r4 r8 | | %{ bar 10: %} R1 | | %{ bar 11: %} r2. c'4 | | %{ bar 12: %} b'4 c''4 d'4 e'4  ~ | | %{ bar 13: %} e'4 r2. | | %{ bar 14: %} r1 | } }
% === END MIDI STAFF ===
