...
4/4
0 5 6 7 | q3 q2 0 0 0 | - - - - | - 0 0 0 |
1 2 3 q3 q2 | - - 0 0 |
2 3 4 q3 q2 | 0 5 6 7 | q3 q2 0 0 0 | 0 0 0 0 |
0 5 6 7 | q3 q2 0 0 0 | 0 5 6 7 | q3 q2 0 0 0 | 0 0 0 0 |
0 5 6 7 | q3 q2 - 0 0
1 2 3 q3 q2 | - - 0 0 |
2 3 4 q3 q2 | - 0 0 0 |
%END
...
| | %{ bar 8: %}
 \note-mod "0" r4
 \note-mod "5" g'4  \note-mod "6" a'4  \note-mod "7" b'4 | | %{ bar 9: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "3" e'8[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
 ...
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 11: %}
 \note-mod "0" r4
 \note-mod "5" g'4  \note-mod "6" a'4  \note-mod "7" b'4 | | %{ bar 12: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "3" e'8[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
 ...
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 13: %}
 \note-mod "0" r4
 \note-mod "5" g'4  \note-mod "6" a'4  \note-mod "7" b'4 | | %{ bar 14: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "3" e'8[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
\set stemRightBeamCount = #1
 \note-mod "2" d'8]
\=JianpuTie(  ~ | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 19: %}
 \note-mod "2" d'4 \=JianpuTie)
 ~  \note-mod "–" d'4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 20: %}
 \note-mod "2" d'4
 \note-mod "3" e'4  \note-mod "4" f'4 \set stemLeftBeamCount = #0
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 g'4 a'4 b'4 | | %{ bar 2: %} e'8 d'8 r2. | | %{ bar 3: %} R1 | | %{ bar 4: %} R1 | | %{ bar 5: %} c'4 d'4 e'4 e'8 d'8  ~ | | %{ bar 6: %} d'2 r2 | | %{ bar 7: %} d'4 e'4 f'4 e'8 d'8 | | %{ bar 8: %} r4 g'4 a'4 b'4 | | %{ bar 9: %} e'8 d'8 r2. | | %{ bar 10: %} R1 | | %{ bar 11: %} r4 g'4 a'4 b'4 | | %{ bar 12: %} e'8 d'8 r2. | | %{ bar 13: %} r4 g'4 a'4 b'4 | | %{ bar 14: %} e'8 d'8 r2. | | %{ bar 15: %} R1 | | %{ bar 16: %} r4 g'4 a'4 b'4 | | %{ bar 17: %} e'8 d'8  ~ d'4 r2 | %{ bar 18: %} c'4 d'4 e'4 e'8 d'8  ~ | | %{ bar 19: %} d'2 r2 | | %{ bar 20: %} d'4 e'4 f'4 e'8 d'8  ~ | | %{ bar 21: %} d'4 r2. | } }
% === END MIDI STAFF ===
