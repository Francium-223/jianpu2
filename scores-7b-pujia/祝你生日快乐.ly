...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'2 e'4 d'8 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} a'8  ~ a'4 r2 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} r4 c'16 r2 r8. | | %{ bar 6: %} R1 | | %{ bar 7: %} b'16 c''16 r2. r8 | | %{ bar 8: %} R1 | | %{ bar 9: %} d''8  ~ d''4 r2 r8 | | %{ bar 10: %} R1 | | %{ bar 11: %} a'8  ~ a'4 r2 r8 | | %{ bar 12: %} R1 | | %{ bar 13: %} g'8 r2. r8 | %{ bar 14: %} a'8  ~ a'4 r2 r8 | | %{ bar 15: %} R1 | | %{ bar 16: %} g'8 r2. r8 } }
% === END MIDI STAFF ===
