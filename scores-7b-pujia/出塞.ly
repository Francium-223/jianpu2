...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { c''4 f'4 f'4 r4 | %{ bar 2: %} a'4 b'4 d'8 r4 r8 | | %{ bar 3: %} R1 | | %{ bar 4: %} e'8  ~ e'4 r2 r8 | | %{ bar 5: %} R1 | | %{ bar 6: %} r8 r2. r8 \repeat volta 2 { } | %{ bar 7: %} c''4 r2. | %{ bar 8: %} c'4 c''4 f'4 f'4 | %{ bar 9: %} a'2 g'8 r4 r8 | | %{ bar 10: %} R1 | | %{ bar 11: %} c''8  ~ c''4 r2 r8 | | %{ bar 12: %} r1 | } }
% === END MIDI STAFF ===
