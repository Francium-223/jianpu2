...
4/4
5 3 - 2 | 6 0 0 0 | 7 1' - 0 | 2' 0 0 0 | 0 0 0 0 |
1 - q2 q2 q2 q2 | 0 0 0 0 |
5 3 - 2 | 6 0 0 0 | 7 1' - 0 | 2' 0 0 0 | 0 0 0 0 |
R{ }
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'4 e'2 d'4 | | %{ bar 2: %} a'4 r2. | | %{ bar 3: %} b'4 c''2 r4 | | %{ bar 4: %} d''4 r2. | | %{ bar 5: %} R1 | | %{ bar 6: %} c'2 d'8 d'8 d'8 d'8 | | %{ bar 7: %} R1 | | %{ bar 8: %} g'4 e'2 d'4 | | %{ bar 9: %} a'4 r2. | | %{ bar 10: %} b'4 c''2 r4 | | %{ bar 11: %} d''4 r2. | | %{ bar 12: %} r1 | \repeat volta 2 { } } }
% === END MIDI STAFF ===
