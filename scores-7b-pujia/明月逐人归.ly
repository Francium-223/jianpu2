...
4/4
6 7 1' 2 | q3 - q5 1' 6 | 1 0 0 0 | q1' 6 0 0 q0 |
6 0 0 0
1' 6 0 0 | 6 0 0 0 |
0 0 0 0 | 0 3 3 - | 2 3 0 0 | q3 6 0 0 q0 |
q5 3 - 2 q0 | 1 0 0 0 | 4 2 1' 6 |
7 - q5 0 q0
1' 1' 2' 2 | q1' 6 0 0 q0 |
%END
%}
...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.Stem.transparent = ##t
     \time 4/4  \note-mod "6" a'4  \note-mod "7" b'4  \note-mod "1" c''4^.  \note-mod "2" d'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 2: %} \set stemLeftBeamCount = #0
...
| | %{ bar 13: %}
 ...
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 14: %}
 \note-mod "4" f'4
 \note-mod "2" d'4  \note-mod "1" c''4^.  \note-mod "6" a'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 15: %}
 \note-mod "7" b'4
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'4 b'4 c''4 d'4 | | %{ bar 2: %} e'8  ~ e'4 g'8 c''4 a'4 | | %{ bar 3: %} c'4 r2. | | %{ bar 4: %} c''8 a'4 r2 r8 | | %{ bar 5: %} a'4 r2. | %{ bar 6: %} c''4 a'4 r2 | | %{ bar 7: %} a'4 r2. | | %{ bar 8: %} R1 | | %{ bar 9: %} r4 e'4 e'2 | | %{ bar 10: %} d'4 e'4 r2 | | %{ bar 11: %} e'8 a'4 r2 r8 | | %{ bar 12: %} g'8 e'2 d'4 r8 | | %{ bar 13: %} c'4 r2. | | %{ bar 14: %} f'4 d'4 c''4 a'4 | | %{ bar 15: %} b'2 g'8 r4 r8 | %{ bar 16: %} c''4 c''4 d''4 d'4 | | %{ bar 17: %} c''8 a'4 r2 r8 | } }
% === END MIDI STAFF ===
