...
4/4
5 - 3 0 | q6 - 0 0 q0 | 0 0 0 0 |
2 - 0 0 | 0 0 0 0 |
q7 0 0 0 q0 | q1. 1' 0 0 s0 | 0 0 0 0 |
q2' 0 0 0 q0 | 0 0 0 0 |
q7 0 0 0 q0 | q1. 0 0 0 s0 |
q2' 0 0 0 q0
q7 0 0 0 q0 | q1. 0 0 0 s0 |
q7 0 0 0 q0 | q1. 0 0 0 s0 |
q7 0 0 0 q0 | q1 0 0 0 q0 |
q7 0 0 0 q0 | q1 0 0 0 q0 |
q2' 0 0 0 q0
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'2 e'4 r4 | | %{ bar 2: %} a'8  ~ a'4 r2 r8 | | %{ bar 3: %} R1 | | %{ bar 4: %} d'2 r2 | | %{ bar 5: %} R1 | | %{ bar 6: %} b'8 r2. r8 | | %{ bar 7: %} c'8. c''4 r2 r16 | | %{ bar 8: %} R1 | | %{ bar 9: %} d''8 r2. r8 | | %{ bar 10: %} R1 | | %{ bar 11: %} b'8 r2. r8 | | %{ bar 12: %} c'8. r2. r16 | | %{ bar 13: %} d''8 r2. r8 | %{ bar 14: %} b'8 r2. r8 | | %{ bar 15: %} c'8. r2. r16 | | %{ bar 16: %} b'8 r2. r8 | | %{ bar 17: %} c'8. r2. r16 | | %{ bar 18: %} b'8 r2. r8 | | %{ bar 19: %} c'8 r2. r8 | | %{ bar 20: %} b'8 r2. r8 | | %{ bar 21: %} c'8 r2. r8 | | %{ bar 22: %} d''8 r2. r8 } }
% === END MIDI STAFF ===
