...
6 - 0 0
3 - 0 0
1 q7 q1' 0 0 | q2' q1' 0 0 0 | 0 0 0 0 |
q2' q1' 0 0 0 | 0 0 0 0 |
q2' q1' 0 0 0 | 0 0 0 0 |
q2' q1' 0 0 0 | 0 0 0 0 |
q2' q1' 0 0 0 | 0 0 0 0 |
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { e'2 g'4 e'4  ~ | | %{ bar 2: %} e'4 g'4 r2 | %{ bar 3: %} a'2 r2 | %{ bar 4: %} a'2 r2 | %{ bar 5: %} a'2 r2 | %{ bar 6: %} e'2 r2 | %{ bar 7: %} c'4 b'8 c''8 r2 | | %{ bar 8: %} d''8 c''8 r2. | | %{ bar 9: %} R1 | | %{ bar 10: %} d''8 c''8 r2. | | %{ bar 11: %} R1 | | %{ bar 12: %} d''8 c''8 r2. | | %{ bar 13: %} R1 | | %{ bar 14: %} d''8 c''8 r2. | | %{ bar 15: %} R1 | | %{ bar 16: %} d''8 c''8 r2. | | %{ bar 17: %} r1 | \repeat volta 2 { } } }
% === END MIDI STAFF ===
