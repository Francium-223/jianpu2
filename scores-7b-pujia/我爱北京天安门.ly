...
4/4
0 5 0 0 | 1' - 1' 0 | - 1' 0 0 | - 6. - q0 | 3 2 1 0 |
7. 7. 0 | - 0 0 0 |
R{ }
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 g'4 r2 | | %{ bar 2: %} c''2 c''4 r4 | | %{ bar 3: %} r4 c''4 r2 | | %{ bar 4: %} r4 a'4.  ~ a'4 r8 | | %{ bar 5: %} e'4 d'4 c'4 r4 | | %{ bar 6: %} b'4. b'4. r4 | | %{ bar 7: %} r1 | \repeat volta 2 { } } }
% === END MIDI STAFF ===
