...
\=JianpuTie(  ~ | | %{ bar 3: %}
 ...
 \note-mod "0" r4 | | %{ bar 9: %}
 \note-mod "0" r4
 \note-mod "0" r4 | \repeat volta 2 { } \repeat volta 2 { } \bar "|." } }
% === END JIANPU STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 a'2 | | %{ bar 2: %} e'4 a'4  ~ | | %{ bar 3: %} a'4 e'4 | %{ bar 4: %} c'2 | | %{ bar 5: %} b'4 r4 | | %{ bar 6: %} R2 | | %{ bar 7: %} R2 | | %{ bar 8: %} R2 | | %{ bar 9: %} r2 | \repeat volta 2 { } \repeat volta 2 { } } }
% === END MIDI STAFF ===
