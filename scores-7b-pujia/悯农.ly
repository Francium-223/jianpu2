...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { e'4 c''4 b'4 c''4 | | %{ bar 2: %} b'4 c''4 b'4 r4 | | %{ bar 3: %} R1 | | %{ bar 4: %} a'4 r2. | | %{ bar 5: %} R1 | | %{ bar 6: %} c''2. r4 | | %{ bar 7: %} R1 | | %{ bar 8: %} g'4 fis'4 r2 | | %{ bar 9: %} R1 | | %{ bar 10: %} c'4 d'4 r2 \repeat volta 2 { } } }
% === END MIDI STAFF ===
