...
%% === BEGIN JIANPU STAFF ===
 ...
 \note-mod "0" r4 | | %{ bar 3: %}
 \note-mod "–" r4
 \note-mod "3" e'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 4: %}
 \note-mod "5" g'4
 ~  \note-mod "–" g'4 | | %{ bar 5: %}
 \note-mod "6" a'4
...
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 14: %}
 \note-mod "1" c''4^.
 ~  \note-mod "–" c''4 | | %{ bar 15: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "7" b'8[
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 g'2 | | %{ bar 2: %} a'4 r4 | | %{ bar 3: %} r4 e'4 | | %{ bar 4: %} g'2 | | %{ bar 5: %} a'4 r4 | | %{ bar 6: %} g'8  ~ g'4 g'8 | | %{ bar 7: %} c'8  ~ c'4 b'8 | | %{ bar 8: %} g'8  ~ g'4 g'8 | | %{ bar 9: %} g'2 | | %{ bar 10: %} a'4 r4 | | %{ bar 11: %} R2 | | %{ bar 12: %} g'8  ~ g'4 g'8 | | %{ bar 13: %} g'8  ~ g'4 g'8 | | %{ bar 14: %} c''2 | | %{ bar 15: %} b'8 r4 r8 | | %{ bar 16: %} g'8  ~ g'4 g'8 | | %{ bar 17: %} g'8  ~ g'4 g'8  ~ | | %{ bar 18: %} g'4 e'4 | } }
% === END MIDI STAFF ===
