...
2/4
0 0 | 5 - | q3 q7 q6 q0 | s1' 0 q0. | d2' 0 q0. d0 | 1 0 | 0 0 |
subtitle=红领巾之歌
q1 q1 q1 q1 | q1 q1 q1 q1 | q1 q1 0 | 0 0 |
q1 q1 q1 q2 | q4 q2 q5 q0 | - - | 0 0 |
q3 6 q0 | 7 1' | 7 d2' q0. d0 | 1 0 | 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 r2 | | %{ bar 2: %} g'2 | | %{ bar 3: %} e'8 b'8 a'8 r8 | | %{ bar 4: %} c''16 r4 r8. | | %{ bar 5: %} d''32 r4 r8. r32 | | %{ bar 6: %} c'4 r4 | | %{ bar 7: %} R2 | | %{ bar 8: %} c'8 c'8 c'8 c'8 | | %{ bar 9: %} c'8 c'8 c'8 c'8 | | %{ bar 10: %} c'8 c'8 r4 | | %{ bar 11: %} R2 | | %{ bar 12: %} c'8 c'8 c'8 d'8 | | %{ bar 13: %} f'8 d'8 g'8 r8 | | %{ bar 14: %} R2 | | %{ bar 15: %} R2 | | %{ bar 16: %} e'8 a'4 r8 | | %{ bar 17: %} b'4 c''4 | | %{ bar 18: %} b'4 d''32 r8. r32 | | %{ bar 19: %} c'4 r4 | | %{ bar 20: %} r2 | } }
% === END MIDI STAFF ===
