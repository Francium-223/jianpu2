...
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "4" f'4
 ~  \note-mod "–" f'4  \note-mod "0" r4 | | %{ bar 6: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \repeat volta 2 { | %{ bar 7: %}
 \note-mod "1" c'4
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "5" g'8[
...
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
} \alternative { { \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 8: %}
 \note-mod "2" d''4^.
 ~  \note-mod "–" d''4  \note-mod "0" r4  \note-mod "0" r4 }} \bar "|." } }
% === END JIANPU STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { a'4 r2. | %{ bar 2: %} e'4 g'8 r2 r8 | | %{ bar 3: %} R1 | | %{ bar 4: %} b'8  ~ b'4 d'2 a'8  ~ | | %{ bar 5: %} a'4 f'2 r4 | | %{ bar 6: %} r1 | \repeat volta 2 { | %{ bar 7: %} c'4 g'8 c''2 r8 } \alternative { { | %{ bar 8: %} d''2 r2 }} } }
% === END MIDI STAFF ===
