...
4/4
5 6 1' 3 | 2 3 7 6 | q0 - - 0 q0 | 0 0 0 0 |
q2 1' - - q0
6 5 6 1' | 2 6 1 -
5 6 1' 3 | 2 0 0 0 | 0 0 0 0 |
3 2 5 3 | 2 1 0 0 | s2 s2 3 6 3 q0 | 2 0 0 0 | 0 0 0 0 |
2 0 0 0
5 3 0 0
2. 1' ,4 q0
6 6 0 0
...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.Stem.transparent = ##t
     \time 4/4  \note-mod "5" g'4  \note-mod "6" a'4  \note-mod "1" c''4^.  \note-mod "3" e'4 | | %{ bar 2: %}
 \note-mod "2" d'4
 \note-mod "3" e'4  \note-mod "7" b'4  \note-mod "6" a'4 | | %{ bar 3: %} \set stemLeftBeamCount = #0
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'4 a'4 c''4 e'4 | | %{ bar 2: %} d'4 e'4 b'4 a'4 | | %{ bar 3: %} r8 r2. r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} d'8 c''2. r8 | %{ bar 6: %} a'4 g'4 a'4 c''4 | | %{ bar 7: %} d'4 a'4 c'2 | %{ bar 8: %} g'4 a'4 c''4 e'4 | | %{ bar 9: %} d'4 r2. | | %{ bar 10: %} R1 | | %{ bar 11: %} e'4 d'4 g'4 e'4 | | %{ bar 12: %} d'4 c'4 r2 | | %{ bar 13: %} d'16 d'16 e'4 a'4 e'4 r8 | | %{ bar 14: %} d'4 r2. | | %{ bar 15: %} R1 | | %{ bar 16: %} d'4 r2. | %{ bar 17: %} g'4 e'4 r2 | %{ bar 18: %} d'4. c''4 f4 r8 | %{ bar 19: %} a'4 a'4 r2 | %{ bar 20: %} e'2 r2 | %{ bar 21: %} d'8 b'8  ~ b'4 r2 | %{ bar 22: %} g'4 c'2 r4 | | %{ bar 23: %} R1 | | %{ bar 24: %} g'4 c''4 r2 | | %{ bar 25: %} r1 | } }
% === END MIDI STAFF ===
