...
4/4
5 6 1' - | q7 - 0 0 q0 | 3 2 q0 0 q0 | q1. 0 0 0 s0 | q1. 0 0 0 s0 | q1. - 0 0 s0 | - 0 0 0 | - 0 0 0 |
R{ }
%END
%}
...
%% === BEGIN JIANPU STAFF ===
 ...
 ~  \note-mod "–" c''4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 2: %} \set stemLeftBeamCount = #0
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'4 a'4 c''2 | | %{ bar 2: %} b'8  ~ b'4 r2 r8 | | %{ bar 3: %} e'4 d'4 r8 r4 r8 | | %{ bar 4: %} c'8. r2. r16 | | %{ bar 5: %} c'8. r2. r16 | | %{ bar 6: %} c'8.  ~ c'4 r2 r16 | | %{ bar 7: %} R1 | | %{ bar 8: %} r1 | \repeat volta 2 { } } }
% === END MIDI STAFF ===
