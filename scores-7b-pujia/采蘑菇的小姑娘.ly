...
3 - - - | 3 - - 0 | q2 1' 0 0 q0 |
- - - 0 | - - - 1' | - 0 0 0 |
6 d5 0 0 q0. d0 | 7 0 0 0 | 0 0 0 0 |
R{ } A{ }
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'1 | | %{ bar 2: %} e'2. r4 | | %{ bar 3: %} d'8 c''4 r2 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} r2. c''4  ~ | | %{ bar 6: %} c''4 r2. | | %{ bar 7: %} a'4 g'32 r2 r8. r32 | | %{ bar 8: %} b'4 r2. | | %{ bar 9: %} r1 | \repeat volta 2 { } \alternative { { }} } }
% === END MIDI STAFF ===
