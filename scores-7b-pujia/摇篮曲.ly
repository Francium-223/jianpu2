...
2 q7 1' 6 q0 | - 0 0 0
3 5 1' 1 | - 0 - 0
0 0 0 0 | 2 q7 1' 6 q0 | 2 q7 1' 6 q0 | 0 0 0 0 |
0 0 0 0 | 5 1' 1 - | 0 - 5 1' | - 0 0 0 | 0 0 0 0 |
2 q7 1' 6 q0
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 d'4 b'8 c''4 a'4 r8 | | %{ bar 2: %} R1 | %{ bar 3: %} e'4 g'4 c''4 c'4  ~ | | %{ bar 4: %} c'4 r2. | %{ bar 5: %} R1 | | %{ bar 6: %} d'4 b'8 c''4 a'4 r8 | | %{ bar 7: %} d'4 b'8 c''4 a'4 r8 | | %{ bar 8: %} R1 | | %{ bar 9: %} R1 | | %{ bar 10: %} g'4 c''4 c'2 | | %{ bar 11: %} r2 g'4 c''4  ~ | | %{ bar 12: %} c''4 r2. | | %{ bar 13: %} R1 | | %{ bar 14: %} d'4 b'8 c''4 a'4 r8 } }
% === END MIDI STAFF ===
