...
5 6' 0 0 | 0 0 0 0 |
2 - 0 0 | 0 0 0 0 |
3 0 0 0 | q7 0 0 0 q0 | 0 0 0 0 |
q1. 0 0 0 s0 | q1. 0 0 0 s0 |
q1 - 0 0 q0 | q1. 0 0 0 s0 |
q1. 0 0 0 s0 | q1 - 0 0 q0 |
q1 - 0 0 q0 | q1. 0 0 0 s0 |
0 0 0 0 | q1. 0 0 0 s0 |
q1 - 0 0 q0 | q1. 0 0 0 s0 |
subtitle=静夜思
...
\set stemRightBeamCount = #2
 \note-mod "0" c'16[]
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 10: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]  ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
\set stemRightBeamCount = #2
 \note-mod "0" c'16[]
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 13: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]  ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 14: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]  ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
| | %{ bar 20: %}
 ...
 \note-mod "6" a''4^.  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 21: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 22: %}
 \note-mod "2" d'4
 ~  \note-mod "–" d'4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 23: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 24: %}
 \note-mod "3" e'4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 25: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "7" b'8[
]   \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
| | %{ bar 30: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8.[
]   \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #2
...
\set stemRightBeamCount = #2
 \note-mod "0" c'16[]
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 32: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]  ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 33: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]  ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
\set stemRightBeamCount = #2
 \note-mod "0" c'16[]
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 37: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]  ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { g'4 a''4 r2 | | %{ bar 2: %} R1 | | %{ bar 3: %} d'2 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} e'4 r2. | | %{ bar 6: %} b'8 r2. r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} c'8. r2. r16 | | %{ bar 9: %} c'8. r2. r16 | | %{ bar 10: %} c'8  ~ c'4 r2 r8 | | %{ bar 11: %} c'8. r2. r16 | | %{ bar 12: %} c'8. r2. r16 | | %{ bar 13: %} c'8  ~ c'4 r2 r8 | | %{ bar 14: %} c'8  ~ c'4 r2 r8 | | %{ bar 15: %} c'8. r2. r16 | | %{ bar 16: %} R1 | | %{ bar 17: %} c'8. r2. r16 | | %{ bar 18: %} c'8  ~ c'4 r2 r8 | | %{ bar 19: %} c'8. r2. r16 | | %{ bar 20: %} g'4 a''4 r2 | | %{ bar 21: %} R1 | | %{ bar 22: %} d'2 r2 | | %{ bar 23: %} R1 | | %{ bar 24: %} e'4 r2. | | %{ bar 25: %} b'8 r2. r8 | | %{ bar 26: %} R1 | | %{ bar 27: %} c'8. r2. r16 | | %{ bar 28: %} c'8. r2. r16 | | %{ bar 29: %} c'8  ~ c'4 r2 r8 | | %{ bar 30: %} c'8. r2. r16 | | %{ bar 31: %} c'8. r2. r16 | | %{ bar 32: %} c'8  ~ c'4 r2 r8 | | %{ bar 33: %} c'8  ~ c'4 r2 r8 | | %{ bar 34: %} c'8. r2. r16 | | %{ bar 35: %} R1 | | %{ bar 36: %} c'8. r2. r16 | | %{ bar 37: %} c'8  ~ c'4 r2 r8 | | %{ bar 38: %} c'8. r2. r16 | } }
% === END MIDI STAFF ===
...
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 11: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]  ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 16: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]  ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
\set stemRightBeamCount = #2
 \note-mod "0" c'16[]
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 20: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]  ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { g'4 a''4 r2 | | %{ bar 2: %} R1 | | %{ bar 3: %} d'2 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} e'4 r2. | | %{ bar 6: %} b'8 r2. r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} c'8. r2. r16 | | %{ bar 9: %} R1 | | %{ bar 10: %} c'8  ~ c'4 r2 r8 | %{ bar 11: %} c'8  ~ c'4 r2 r8 | | %{ bar 12: %} R1 | | %{ bar 13: %} c'8. r2. r16 | | %{ bar 14: %} R1 | | %{ bar 15: %} c'8  ~ c'4 r2 r8 | %{ bar 16: %} c'8  ~ c'4 r2 r8 | | %{ bar 17: %} R1 | | %{ bar 18: %} R1 | | %{ bar 19: %} c'8. r2. r16 | | %{ bar 20: %} c'8  ~ c'4 r2 r8 | | %{ bar 21: %} c'8. r2. r16 | } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="b" { g'4 a''4 r2 | | %{ bar 2: %} R1 | | %{ bar 3: %} d'2 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} e'4 r2. | | %{ bar 6: %} b'8 r2. r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} c'8. r2. r16 | | %{ bar 9: %} R1 | | %{ bar 10: %} c'8  ~ c'4 r2 r8 | %{ bar 11: %} c'8  ~ c'4 r2 r8 | | %{ bar 12: %} R1 | | %{ bar 13: %} c'8. r2. r16 | | %{ bar 14: %} R1 | | %{ bar 15: %} c'8  ~ c'4 r2 r8 | %{ bar 16: %} c'8  ~ c'4 r2 r8 | | %{ bar 17: %} R1 | | %{ bar 18: %} R1 | | %{ bar 19: %} c'8. r2. r16 | | %{ bar 20: %} c'8  ~ c'4 r2 r8 | | %{ bar 21: %} c'8. r2. r16 | } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="d" { f'4 g''4 r2 | | %{ bar 2: %} R1 | | %{ bar 3: %} d'2 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} e'4 r2. | | %{ bar 6: %} b'8 r2. r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} c'8. r2. r16 | | %{ bar 9: %} R1 | | %{ bar 10: %} c'8  ~ c'4 r2 r8 | %{ bar 11: %} c'8  ~ c'4 r2 r8 | | %{ bar 12: %} R1 | | %{ bar 13: %} c'8. r2. r16 | | %{ bar 14: %} R1 | | %{ bar 15: %} c'8  ~ c'4 r2 r8 | %{ bar 16: %} c'8  ~ c'4 r2 r8 | | %{ bar 17: %} R1 | | %{ bar 18: %} R1 | | %{ bar 19: %} c'8. r2. r16 | | %{ bar 20: %} c'8  ~ c'4 r2 r8 | | %{ bar 21: %} c'8. r2. r16 | } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="f" { g'4 a''4 r2 | | %{ bar 2: %} R1 | | %{ bar 3: %} d'2 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} e'4 r2. | | %{ bar 6: %} b'8 r2. r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} c'8. r2. r16 | | %{ bar 9: %} R1 | | %{ bar 10: %} c'8  ~ c'4 r2 r8 | %{ bar 11: %} c'8  ~ c'4 r2 r8 | | %{ bar 12: %} R1 | | %{ bar 13: %} c'8. r2. r16 | | %{ bar 14: %} R1 | | %{ bar 15: %} c'8  ~ c'4 r2 r8 | %{ bar 16: %} c'8  ~ c'4 r2 r8 | | %{ bar 17: %} R1 | | %{ bar 18: %} R1 | | %{ bar 19: %} c'8. r2. r16 | | %{ bar 20: %} c'8  ~ c'4 r2 r8 | | %{ bar 21: %} c'8. r2. r16 | } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="XX" { g'4 a''4 r2 | | %{ bar 2: %} R1 | | %{ bar 3: %} d'2 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} e'4 r2. | | %{ bar 6: %} b'8 r2. r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} c'8. r2. r16 | | %{ bar 9: %} R1 | | %{ bar 10: %} c'8  ~ c'4 r2 r8 | %{ bar 11: %} c'8  ~ c'4 r2 r8 | | %{ bar 12: %} R1 | | %{ bar 13: %} c'8. r2. r16 | | %{ bar 14: %} R1 | | %{ bar 15: %} c'8  ~ c'4 r2 r8 | %{ bar 16: %} c'8  ~ c'4 r2 r8 | | %{ bar 17: %} R1 | | %{ bar 18: %} R1 | | %{ bar 19: %} c'8. r2. r16 | | %{ bar 20: %} c'8  ~ c'4 r2 r8 | | %{ bar 21: %} c'8. r2. r16 | } }
% === END MIDI STAFF ===
...
\set stemRightBeamCount = #2
 \note-mod "0" c'16[]
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 19: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]  ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="XZ" { f'4 g''4 r2 | | %{ bar 2: %} R1 | | %{ bar 3: %} d'2 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} e'4 r2. | | %{ bar 6: %} b'8 r2. r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} c'8. r2. r16 | | %{ bar 9: %} R1 | | %{ bar 10: %} c'8  ~ c'4 r2 r8 | %{ bar 11: %} c'8  ~ c'4 r2 r8 | | %{ bar 12: %} R1 | | %{ bar 13: %} c'8. r2. r16 | | %{ bar 14: %} R1 | | %{ bar 15: %} c'8  ~ c'4 r2 r8 | %{ bar 16: %} c'8  ~ c'4 r2 r8 | %{ bar 17: %} R1 | | %{ bar 18: %} c'8. r2. r16 | | %{ bar 19: %} c'8  ~ c'4 r2 r8 | | %{ bar 20: %} c'8. r2. r16 | } }
% === END MIDI STAFF ===
