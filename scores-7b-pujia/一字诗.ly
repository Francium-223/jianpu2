...
4/4
5 - q0 0 q0 | 0 0 0 0 |
6 q2 - 3 q0 | - q7 0 0 q0 | 0 0 0 0 |
5 q6 1 2 q0 | 3 0 0 0 | 0 0 0 0 |
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'2 r8 r4 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} a'4 d'8  ~ d'4 e'4 r8 | | %{ bar 4: %} r4 b'8 r2 r8 | | %{ bar 5: %} R1 | | %{ bar 6: %} g'4 a'8 c'4 d'4 r8 | | %{ bar 7: %} e'4 r2. | | %{ bar 8: %} R1 | | %{ bar 9: %} R1 | | %{ bar 10: %} R1 | | %{ bar 11: %} R1 | | %{ bar 12: %} g'4 c''4 d''4 r4 | | %{ bar 13: %} R1 | | %{ bar 14: %} a'4 d'8  ~ d'4 e'4 r8 | | %{ bar 15: %} r4 b'8 r2 r8 | | %{ bar 16: %} R1 | | %{ bar 17: %} g'4 a'8 c'4 d'4 r8 | | %{ bar 18: %} e'4 r2. | | %{ bar 19: %} R1 | | %{ bar 20: %} g'4 c''4 r2 | | %{ bar 21: %} r1 | } }
% === END MIDI STAFF ===
