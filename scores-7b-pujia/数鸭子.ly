...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'4 g'8  ~ g'4 r4 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} a'8 c''8  ~ c''4 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} c''8 b'16 d''2 r4 r16 | | %{ bar 6: %} R1 | | %{ bar 7: %} g'8 r2. r8 | | %{ bar 8: %} R1 | | %{ bar 9: %} a'8 c''8  ~ c''4 r2 | | %{ bar 10: %} r1 | } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { d''4 g'8.  ~ g'4 r4 r16 | | %{ bar 2: %} R1 | | %{ bar 3: %} c''2 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} f'16 r2. r8. | | %{ bar 6: %} r1 | } }
% === END MIDI STAFF ===
