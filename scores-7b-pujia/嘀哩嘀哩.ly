...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.Stem.transparent = ##t
     \time 2/4  \note-mod "5" g'4  \note-mod "6" a'4 | | %{ bar 2: %} \set stemLeftBeamCount = #0
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 g'4 a'4 | | %{ bar 2: %} e'8 b'8 r4 | | %{ bar 3: %} R2 | | %{ bar 4: %} R2 | | %{ bar 5: %} R2 | | | %{ bar 6: %} R2 | | %{ bar 7: %} R2 | | %{ bar 8: %} g'4 a'4 | | %{ bar 9: %} R2 | | %{ bar 10: %} R2 | | %{ bar 11: %} c'8 c'8 r4 | | %{ bar 12: %} c'8 c'8 r4 | | %{ bar 13: %} r2 | } }
% === END MIDI STAFF ===
