...
subtitle=小红帽
1 - | 3 5 | - 7
0 0 | q6 0 q0 | q1' 0 q0 | 0 0 |
0 0 | q6 0 q0 | q1' 0 q0 | 0 0 |
2' - | 1 0 | 1 ,3 | 1 5 | q6 0 q0 | 0 0 |
%END
%}
...
| | %{ bar 15: %}
 \note-mod "1" c'4
 \note-mod "5" g'4 | | %{ bar 16: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "6" a'8[
]   \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 c'2 | | %{ bar 2: %} e'4 g'4  ~ | | %{ bar 3: %} g'4 b'4 | %{ bar 4: %} R2 | | %{ bar 5: %} a'8 r4 r8 | | %{ bar 6: %} c''8 r4 r8 | | %{ bar 7: %} R2 | | %{ bar 8: %} R2 | | %{ bar 9: %} a'8 r4 r8 | | %{ bar 10: %} c''8 r4 r8 | | %{ bar 11: %} R2 | | %{ bar 12: %} d''2 | | %{ bar 13: %} c'4 r4 | | %{ bar 14: %} c'4 e4 | | %{ bar 15: %} c'4 g'4 | | %{ bar 16: %} a'8 r4 r8 | | %{ bar 17: %} r2 | } }
% === END MIDI STAFF ===
