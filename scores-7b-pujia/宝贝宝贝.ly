...
4/4
1' - 0 0 | q2 q0 0 0 0 | 0 0 0 0 |
q3 - 7 q6 q5 q0 | 0 0 0 0 |
1' 1 - 0 | q2 q0 0 0 0 | 0 0 0 0 |
q1' q2' q1 0 0 q0 | 0 0 0 0 |
q1 1 q1 2 q1 q0 | 3 0 0 0 | 0 0 0 0 |
q1 4 q1 5 q1 q0 | 6 0 0 0
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 c''2 r2 | | %{ bar 2: %} d'8 r8 r2. | | %{ bar 3: %} R1 | | %{ bar 4: %} e'8  ~ e'4 b'4 a'8 g'8 r8 | | %{ bar 5: %} R1 | | %{ bar 6: %} c''4 c'2 r4 | | %{ bar 7: %} d'8 r8 r2. | | %{ bar 8: %} R1 | | %{ bar 9: %} c''8 d''8 c'8 r2 r8 | | %{ bar 10: %} R1 | | %{ bar 11: %} c'8 c'4 c'8 d'4 c'8 r8 | | %{ bar 12: %} e'4 r2. | | %{ bar 13: %} R1 | | %{ bar 14: %} c'8 f'4 c'8 g'4 c'8 r8 | | %{ bar 15: %} a'4 r2. } }
% === END MIDI STAFF ===
