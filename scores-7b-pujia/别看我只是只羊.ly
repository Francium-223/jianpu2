...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 e'4 d'8 a'8 r4 | | %{ bar 2: %} R1 | | %{ bar 3: %} g'8 b'8  ~ b'4 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} r4 c''4 r2 | | %{ bar 6: %} R1 | | %{ bar 7: %} c'4 d'4 d'8 a'8 r4 | | %{ bar 8: %} R1 | | %{ bar 9: %} g'8 b'8 r2. | | %{ bar 10: %} r1 | \repeat volta 2 { } | | } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { c'4 d'4 d'8 a'8 r4 | | %{ bar 2: %} R1 | | %{ bar 3: %} f'8 e'8 d'8 a'8 r2 | | %{ bar 4: %} r1 | } }
% === END MIDI STAFF ===
