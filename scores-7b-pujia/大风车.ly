...
4/4
5 - - q3 q2 | 1' 7 6 0 | 0 0 0 0 | 0 0 0 0 |
q0 d1 q0 2 0 q0. d0 | 0 0 0 0 |
5 - - q3 q2 | 1' 7 6 0 | 0 0 0 0 | 0 0 0 0 |
q0 d1 q0 2 0 q0. d0 | 0 0 0 0 |
subtitle=大风车转悠悠
...
5 4 b3 2 | 1' 0 0 0 | 0 0 0 0 |
q0 d1 2 0 0 s0. | 0 0 0 0 |
0 0 0 0 | 5 - - q3 q2 | 1' 7 6 0 | 0 0 0 0 | 0 0 0 0 |
q0 d1 q0 2 0 q0. d0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'2. e'8 d'8 | | %{ bar 2: %} c''4 b'4 a'4 r4 | | %{ bar 3: %} R1 | | %{ bar 4: %} R1 | | %{ bar 5: %} r8 c'32 r8 d'4 r4 r8. r32 | | %{ bar 6: %} R1 | | %{ bar 7: %} g'2. e'8 d'8 | | %{ bar 8: %} c''4 b'4 a'4 r4 | | %{ bar 9: %} R1 | | %{ bar 10: %} R1 | | %{ bar 11: %} r8 c'32 r8 d'4 r4 r8. r32 | | %{ bar 12: %} r1 | } }
% === END MIDI STAFF ===
...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.TimeSignature.style = #'numbered
    \override Staff.Stem.transparent = ##t
      \note-mod "5" g'4  \note-mod "4" f'4  \note-mod "3" \once \tweak Accidental.extra-offset #'(0 . 0.7)ees'4
 \note-mod "2" d'4 | | %{ bar 2: %}
 \note-mod "1" c''4^.
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 3: %}
 \note-mod "0" r4
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { g'4 f'4 ees'4 d'4 | | %{ bar 2: %} c''4 r2. | | %{ bar 3: %} R1 | | %{ bar 4: %} r8 c'32 d'4 r2 r16. | | %{ bar 5: %} R1 | | %{ bar 6: %} R1 | | %{ bar 7: %} g'2. e'8 d'8 | | %{ bar 8: %} c''4 b'4 a'4 r4 | | %{ bar 9: %} R1 | | %{ bar 10: %} R1 | | %{ bar 11: %} r8 c'32 r8 d'4 r4 r8. r32 | | %{ bar 12: %} r1 | } }
% === END MIDI STAFF ===
