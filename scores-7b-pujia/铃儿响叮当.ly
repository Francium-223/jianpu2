...
4/4
3 - - 0 | q5 q2 q7 - 0 q0 | 0 0 0 0 |
q6 q6 q1 0 q1' 0 | 0 0 0 0 |
q2' q1' q7 q6 0 0 | 0 0 0 0 |
q5 q2 q7. 0 0 s0
q5 q2 0 0 0
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'2. r4 | | %{ bar 2: %} g'8 d'8 b'8  ~ b'4 r4 r8 | | %{ bar 3: %} R1 | | %{ bar 4: %} a'8 a'8 c'8 r4 c''8 r4 | | %{ bar 5: %} R1 | | %{ bar 6: %} d''8 c''8 b'8 a'8 r2 | | %{ bar 7: %} R1 | | %{ bar 8: %} g'8 d'8 b'8. r2 r16 | %{ bar 9: %} g'8 d'8 r2. } }
% === END MIDI STAFF ===
