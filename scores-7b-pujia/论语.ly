...
4/4
2 - 0 0 | q3 q7 q6 q5 0 0 | 0 0 0 0 |
q1' q2' q1 0 q1 1 | q1 - 0 0 q0 | q1 - q1 - q1 q0 | - q1 0 0 q0 | 0 0 0 0 |
q1 2 q1 1 q1 q0 | 0 q2' 0 0 q0 | q1' q7 q6 q5 0 0 | 0 0 0 0 |
q4 q3 q2 q1 - 0 | q2 q3 q4 q5 0 0 | 0 0 0 0 |
q6 q7 q1' q2' 0 0 | q1 0 - 0 q0 | 1 - - 0 | 0 0 0 0 |
q1 - q1 - q1 q0 | - q1 0 0 q0 | 0 0 0 0 |
q2 q3 q4 q5 0 0 | 0 0 0 0 |
%END
%}
...
\set stemRightBeamCount = #1
 \note-mod "1" c'8[]
 \note-mod "1" c'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 5: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]  ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 d'2 r2 | | %{ bar 2: %} e'8 b'8 a'8 g'8 r2 | | %{ bar 3: %} R1 | | %{ bar 4: %} c''8 d''8 c'8 r4 c'8 c'4 | | %{ bar 5: %} c'8  ~ c'4 r2 r8 | | %{ bar 6: %} c'8  ~ c'4 c'8  ~ c'4 c'8 r8 | | %{ bar 7: %} r4 c'8 r2 r8 | | %{ bar 8: %} R1 | | %{ bar 9: %} c'8 d'4 c'8 c'4 c'8 r8 | | %{ bar 10: %} r4 d''8 r2 r8 | | %{ bar 11: %} c''8 b'8 a'8 g'8 r2 | | %{ bar 12: %} R1 | | %{ bar 13: %} f'8 e'8 d'8 c'8  ~ c'4 r4 | | %{ bar 14: %} d'8 e'8 f'8 g'8 r2 | | %{ bar 15: %} R1 | | %{ bar 16: %} a'8 b'8 c''8 d''8 r2 | | %{ bar 17: %} c'8 r2. r8 | | %{ bar 18: %} c'2. r4 | | %{ bar 19: %} R1 | | %{ bar 20: %} c'8  ~ c'4 c'8  ~ c'4 c'8 r8 | | %{ bar 21: %} r4 c'8 r2 r8 | | %{ bar 22: %} R1 | | %{ bar 23: %} d'8 e'8 f'8 g'8 r2 | | %{ bar 24: %} r1 | } }
% === END MIDI STAFF ===
