...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.Stem.transparent = ##t
     \time 2/4  \note-mod "3" e'4  \note-mod "5" g'4 | | %{ bar 2: %} \set stemLeftBeamCount = #0
...
| | %{ bar 3: %}
 ...
 \note-mod "0" r4 | | %{ bar 7: %}
 \note-mod "6" a'4
 \note-mod "6" a'4 | | %{ bar 8: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "6" a'8[
]   \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 e'4 g'4 | | %{ bar 2: %} g'8 r4 r8 | | %{ bar 3: %} R2 | | %{ bar 4: %} c'2 | | %{ bar 5: %} R2 | | %{ bar 6: %} R2 | | %{ bar 7: %} a'4 a'4 | | %{ bar 8: %} a'8 r4 r8 | | %{ bar 9: %} r2 | \repeat volta 2 { } } }
% === END MIDI STAFF ===
