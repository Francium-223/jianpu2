...
4/4
1' 5 - 3 | q6 2 q7 0 0 | 0 0 0 0 |
1' 5 - 3 | q6 2 q7 0 0 | 0 0 0 0 |
q1 q1 - 0 0 | 0 0 0 0 |
q0 q6 q7 q1' 0 0 | 0 0 0 0 |
q2' q7 q6 q5 0 0 | 0 0 0 0 |
q4 q3 q2 q1 0 0 | 0 0 0 0 |
R{ }
%END
%}
...
%% === BEGIN JIANPU STAFF ===
 ...
 ~  \note-mod "–" g'4  \note-mod "3" e'4 | | %{ bar 2: %} \set stemLeftBeamCount = #0
...
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "5" g'4
 ~  \note-mod "–" g'4  \note-mod "3" e'4 | | %{ bar 5: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "6" a'8[
]   \note-mod "2" d'4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 c''4 g'2 e'4 | | %{ bar 2: %} a'8 d'4 b'8 r2 | | %{ bar 3: %} R1 | | %{ bar 4: %} c''4 g'2 e'4 | | %{ bar 5: %} a'8 d'4 b'8 r2 | | %{ bar 6: %} R1 | | %{ bar 7: %} c'8 c'8  ~ c'4 r2 | | %{ bar 8: %} R1 | | %{ bar 9: %} r8 a'8 b'8 c''8 r2 | | %{ bar 10: %} R1 | | %{ bar 11: %} d''8 b'8 a'8 g'8 r2 | | %{ bar 12: %} R1 | | %{ bar 13: %} f'8 e'8 d'8 c'8 r2 | | %{ bar 14: %} r1 | \repeat volta 2 { } } }
% === END MIDI STAFF ===
