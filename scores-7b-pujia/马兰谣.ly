...
1' 4 4 0
6 - 2 3 | 5 7 6 0 | 0 0 0 0 |
3 0 0 0 | 0 0 0 0 |
subtitle=副歌1 0 0 0 0
6 - 2 3 | 5 7 6 0 | 0 0 0 0 |
3 0 0 0 | 0 0 0 0 |
|
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { c''4 f'4 f'4 r4 | %{ bar 2: %} a'2 d'4 e'4 | | %{ bar 3: %} g'4 b'4 a'4 r4 | | %{ bar 4: %} R1 | | %{ bar 5: %} e'4 r2. | | %{ bar 6: %} R1 | | %{ bar 7: %} a'2 d'4 e'4 | | %{ bar 8: %} g'4 b'4 a'4 r4 | | %{ bar 9: %} R1 | | %{ bar 10: %} e'4 r2. | | %{ bar 11: %} r1 | | } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { a'2 d'4 e'4 | | %{ bar 2: %} g'4 b'4 a'4 r4 | | %{ bar 3: %} R1 | | %{ bar 4: %} e'4 r2. | | %{ bar 5: %} r1 | } }
% === END MIDI STAFF ===
