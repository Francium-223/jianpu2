...
4/4
2 q5 - 0 q0
3 s6 d7 1' 2' q0 d0 | 0 1 b2 3' | 'd4 0 0 0 q0. d0
R{ } A{ }
subtitle=副歌
2 q5 - 0 q0
3 s6 d7 1' 2' q0 d0 | 0 1 b2 3' | 'd4 0 0 0 q0. d0
...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.Stem.transparent = ##t
     \time 4/4  \note-mod "2" d'4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 \set stemLeftBeamCount = #0
...
| | %{ bar 3: %}
 ...
 \note-mod "3" e''4^. | | %{ bar 4: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #3
 \note-mod "4" f''32^.[
]   \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
\set stemRightBeamCount = #3
 \note-mod "0" r32]
\repeat volta 2 { } \alternative { { }} | %{ bar 5: %}
 \note-mod "2" d'4
...
| | %{ bar 7: %}
 \note-mod "0" r4
 \note-mod "1" c'4  \note-mod "2" \once \tweak Accidental.extra-offset #'(0 . 0.7)des'4
 \note-mod "3" e''4^. | | %{ bar 8: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #3
 \note-mod "4" f''32^.[
]   \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 d'4 g'8  ~ g'4 r4 r8 | %{ bar 2: %} e'4 a'16 b'32 c''4 d''4 r8 r32 | | %{ bar 3: %} r4 c'4 des'4 e''4 | | %{ bar 4: %} f''32 r2. r8. r32 \repeat volta 2 { } \alternative { { }} | %{ bar 5: %} d'4 g'8  ~ g'4 r4 r8 | %{ bar 6: %} e'4 a'16 b'32 c''4 d''4 r8 r32 | | %{ bar 7: %} r4 c'4 des'4 e''4 | | %{ bar 8: %} f''32 r2. r8. r32 } }
% === END MIDI STAFF ===
