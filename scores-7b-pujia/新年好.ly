...
1' 3 4 0
subtitle=新年好
2 - 0 0 | q6 q5 q7 0 0 q0 | s1 q0 s1' 0 0 0 | 2' 0 0 0 | 0 0 0 0 |
2 - 0 0 | q6 q5 q7 0 0 q0 | s1 q0 s1' 0 0 0 | d2' 0 0 0 q0. d0 | 0 0 0 0 |
1' 3 4 0
NextScore
subtitle=Happy
2 - 0 0 | q6 q5 q7 0 0 q0 | s1 q0 0 0 0 s0 | 0 0 0 0 | 0 0 0 0 |
2 - 0 0 | q6 q5 q7 0 0 q0 | s1 q0 d2' 0 0 0 d0 | 0 0 0 0 |
1' 4 4 0
NextScore
subtitle=新年好
3 - 0 0 | q1' q7 q2' 0 0 q0 | s1 q0 0 0 0 s0 | 0 0 0 0 | 0 0 0 0 |
2 - 0 0 | q6 q5 q7 0 0 q0 | s1 q0 d2' 0 0 0 d0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { c''4 e'4 f'4 r4 | %{ bar 2: %} d'2 r2 | | %{ bar 3: %} a'8 g'8 b'8 r2 r8 | | %{ bar 4: %} c'16 r8 c''16 r2. | | %{ bar 5: %} d''4 r2. | | %{ bar 6: %} R1 | | %{ bar 7: %} d'2 r2 | | %{ bar 8: %} a'8 g'8 b'8 r2 r8 | | %{ bar 9: %} c'16 r8 c''16 r2. | | %{ bar 10: %} d''32 r2. r8. r32 | | %{ bar 11: %} R1 | | %{ bar 12: %} c''4 e'4 f'4 r4 } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { d'2 r2 | | %{ bar 2: %} a'8 g'8 b'8 r2 r8 | | %{ bar 3: %} c'16 r8 r2. r16 | | %{ bar 4: %} R1 | | %{ bar 5: %} R1 | | %{ bar 6: %} d'2 r2 | | %{ bar 7: %} a'8 g'8 b'8 r2 r8 | | %{ bar 8: %} c'16 r8 d''32 r2. r32 | | %{ bar 9: %} R1 | | %{ bar 10: %} c''4 f'4 f'4 r4 } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="b" { e'2 r2 | | %{ bar 2: %} c''8 b'8 d''8 r2 r8 | | %{ bar 3: %} c'16 r8 r2. r16 | | %{ bar 4: %} R1 | | %{ bar 5: %} R1 | | %{ bar 6: %} d'2 r2 | | %{ bar 7: %} a'8 g'8 b'8 r2 r8 | | %{ bar 8: %} c'16 r8 d''32 r2. r32 | | %{ bar 9: %} r1 | } }
% === END MIDI STAFF ===
