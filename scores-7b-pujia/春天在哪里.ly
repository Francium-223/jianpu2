...
| | %{ bar 12: %}
 \note-mod "0" r4
 \note-mod "0" r4 | \repeat volta 2 { } \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 13: %}
 \note-mod "5" g'4
 ~  \note-mod "–" g'4 | | %{ bar 14: %}
 \note-mod "5" g'4
 \note-mod "0" r4 | | %{ bar 15: %}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 e'4 e'8 r8 | | %{ bar 2: %} R2 | | %{ bar 3: %} g'2 | | %{ bar 4: %} R2 | | %{ bar 5: %} e'4 e'8 r8 | | %{ bar 6: %} R2 | | | %{ bar 7: %} a'4 b'4 | | %{ bar 8: %} c'4 r4 | | %{ bar 9: %} r8 r4 r8 | | %{ bar 10: %} R2 | | %{ bar 11: %} e'4 e'8 r8 | | %{ bar 12: %} r2 | \repeat volta 2 { } | %{ bar 13: %} g'2 | | %{ bar 14: %} g'4 r4 | | %{ bar 15: %} R2 | | %{ bar 16: %} g4 r4 | | %{ bar 17: %} R2 | | %{ bar 18: %} g'4 d'4 | | %{ bar 19: %} R2 | | %{ bar 20: %} f2 } }
% === END MIDI STAFF ===
...
%% === BEGIN JIANPU STAFF ===
 ...
 \note-mod "0" r4
 \note-mod "0" r4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "5" g'4
 ~  \note-mod "–" g'4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 3: %}
 \note-mod "3" e'4
 ~  \note-mod "–" e'4  \note-mod "5" g4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 \note-mod "0" r4 | %{ bar 4: %}
 \note-mod "2" d''4^.
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { c'4 r4 e'2 | | %{ bar 2: %} r2 | g'2 | %{ bar 3: %} e'2 g4 r4 | %{ bar 4: %} d''4 r4 a'4 b'4 | | %{ bar 5: %} c''4 c''4 | g4 r4 | %{ bar 6: %} g'4. r8 c'4 c''4 | %{ bar 7: %} r8 r4 r8 | r2 | | | %{ bar 8: %} g'2 | r2 | } }
% === END MIDI STAFF ===
