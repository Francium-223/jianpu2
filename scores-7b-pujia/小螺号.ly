...
\=JianpuTie(  ~ | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 6: %}
 \note-mod "6" a'4 \=JianpuTie)
 ~  \note-mod "–" a'4 | | %{ bar 7: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "3" e'8[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
\=JianpuTie(  ~ \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "–" a'4
 ...
 \note-mod "2" d'4
 ~  \note-mod "–" d'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 14: %}
 \note-mod "4" f'4
 ~  \note-mod "–" f'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 15: %}
 \note-mod "5" g'4
 ~  \note-mod "–" g'4 | | %{ bar 16: %}
 \note-mod "7" b'4
...
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 23: %}
 \note-mod "2" d'4
 ~  \note-mod "–" d'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 24: %}
 \note-mod "4" f'4
 ~  \note-mod "–" f'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 25: %}
 \note-mod "5" g'4
 ~  \note-mod "–" g'4 | | %{ bar 26: %}
 \note-mod "7" b'4
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 a'2  ~ | | %{ bar 2: %} a'4 r4 | | %{ bar 3: %} e'8 e'8 r4 | | %{ bar 4: %} R2 | | %{ bar 5: %} r4 a'4  ~ | | %{ bar 6: %} a'2 | | %{ bar 7: %} e'8 e'8 r4 | | %{ bar 8: %} R2 | | %{ bar 9: %} R2 | | %{ bar 10: %} c'4. r8 | %{ bar 11: %} a'2  ~ | | %{ bar 12: %} a'4 r4 | | %{ bar 13: %} d'2 | | %{ bar 14: %} f'2 | | %{ bar 15: %} g'2 | | %{ bar 16: %} b'4 r4 | | %{ bar 17: %} a'2  ~ | | %{ bar 18: %} a'4 r4 | | %{ bar 19: %} e'16 e'16 r4 r8 | | %{ bar 20: %} R2 | | %{ bar 21: %} R2 | | %{ bar 22: %} c'4. r8 | %{ bar 23: %} d'2 | | %{ bar 24: %} f'2 | | %{ bar 25: %} g'2 | | %{ bar 26: %} b'4 r4 | %{ bar 27: %} a'2  ~ | | %{ bar 28: %} a'4 r4 | | %{ bar 29: %} r4 e'8 r8 | | %{ bar 30: %} c''2 | | %{ bar 31: %} d''4 r4 | } }
% === END MIDI STAFF ===
