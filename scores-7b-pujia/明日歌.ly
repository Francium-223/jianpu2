...
4/4
6 3 q2 1' q0 | 1' 0 0 0 | 0 0 0 0 |
q7 - - 1' q0 | 0 0 0 0 |
5 2 s1 0 q0. | 0 0 0 0 |
6 1 d1 1 q0. d0 | 1 0 0 0 | 0 0 0 0 |
6 3 q2 1' q0 | 1' 0 0 0 | 0 0 0 0 |
q7 - - - q0 | - 1' 0 0 | 0 0 0 0 |
6 3 q2 1' q0 | 1' 0 0 0 | 0 0 0 0 |
q7 - - 1' q0 | 0 0 0 0 |
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'4 e'4 d'8 c''4 r8 | | %{ bar 2: %} c''4 r2. | | %{ bar 3: %} R1 | | %{ bar 4: %} b'8  ~ b'2 c''4 r8 | | %{ bar 5: %} R1 | | %{ bar 6: %} g'4 d'4 c'16 r4 r8. | | %{ bar 7: %} R1 | | %{ bar 8: %} a'4 c'4 c'32 c'4 r8. r32 | | %{ bar 9: %} c'4 r2. | | %{ bar 10: %} R1 | | %{ bar 11: %} a'4 e'4 d'8 c''4 r8 | | %{ bar 12: %} c''4 r2. | | %{ bar 13: %} R1 | | %{ bar 14: %} b'8  ~ b'2. r8 | | %{ bar 15: %} r4 c''4 r2 | | %{ bar 16: %} R1 | | %{ bar 17: %} a'4 e'4 d'8 c''4 r8 | | %{ bar 18: %} c''4 r2. | | %{ bar 19: %} R1 | | %{ bar 20: %} b'8  ~ b'2 c''4 r8 | | %{ bar 21: %} R1 | | %{ bar 22: %} g'4 d'4 c'16 r4 r8. | | %{ bar 23: %} R1 | | %{ bar 24: %} a'4 c'4 c'32 c'4 r8. r32 | | %{ bar 25: %} c'4 r2. | | %{ bar 26: %} R1 | | %{ bar 27: %} c''4 f'4 d'8 c''4 r8 | | %{ bar 28: %} c''4 r2. | | %{ bar 29: %} R1 | | %{ bar 30: %} b'8  ~ b'2. r8 | | %{ bar 31: %} r4 c''4 r2 | | %{ bar 32: %} r1 | \repeat volta 2 { } } }
% === END MIDI STAFF ===
