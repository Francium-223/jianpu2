...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 a'4 r4 | | %{ bar 2: %} g'8  ~ g'4 r8 | | %{ bar 3: %} R2 | | %{ bar 4: %} e'8 r4 r8 | %{ bar 5: %} c'8. r4 r16 | | %{ bar 6: %} R2 | | %{ bar 7: %} c''4 r4 | %{ bar 8: %} b'8  ~ b'4 r8 | %{ bar 9: %} a'8. r4 r16 | %{ bar 10: %} g'8. r4 r16 } }
% === END MIDI STAFF ===
