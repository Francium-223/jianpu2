...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'4 e'4 a'2  ~ | | %{ bar 2: %} a'4 r2. | | %{ bar 3: %} R1 | | %{ bar 4: %} d'1 | | %{ bar 5: %} R1 | | %{ bar 6: %} g'4 g'4 a'2 | | %{ bar 7: %} R1 | | %{ bar 8: %} c'4 d'4. r4 r8 | | %{ bar 9: %} R1 | | %{ bar 10: %} g'4 e'4 b'2  ~ | | %{ bar 11: %} b'4 r4. r4 r8 | | %{ bar 12: %} r1 | } }
% === END MIDI STAFF ===
