...
subtitle=红星歌
2 - 0 0
6 0 q3 0 q0 | 7 5 q1 0 q0 | 1' 5 q1 0 q0 | 0 0 0 0 |
1' 5 q1 0 q0 | 0 0 0 0 |
1 - 0 0
2. 0 0 q0
2. 0 0 q0
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 d'2 r2 | %{ bar 2: %} a'4 r4 e'8 r4 r8 | | %{ bar 3: %} b'4 g'4 c'8 r4 r8 | | %{ bar 4: %} c''4 g'4 c'8 r4 r8 | | %{ bar 5: %} R1 | | %{ bar 6: %} c''4 g'4 c'8 r4 r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} c'2 r2 | %{ bar 9: %} d'4. r2 r8 | %{ bar 10: %} d'4. r2 r8 | %{ bar 11: %} d'4.  ~ d'2 r8 } }
% === END MIDI STAFF ===
