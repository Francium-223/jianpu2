...
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
\repeat volta 2 { } \alternative { { }} | %{ bar 6: %}
 \note-mod "3" e'4
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'4 d'8  ~ d'4 r4 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} a'4 g'8 b'8 c''8 d''8 r8 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} c'8 r2. r8 \repeat volta 2 { } \alternative { { }} | %{ bar 6: %} e'4 d'8  ~ d'4 r4 r8 | | %{ bar 7: %} r1 | } }
% === END MIDI STAFF ===
