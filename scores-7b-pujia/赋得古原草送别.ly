...
6 0 0 0
subtitle=intro
4 - 2 3 | q5 q7 0 0 0 | s0 0 0 0 q0. | d1 - 0 0 q0. d0 | - 0 0 0 |
1' - 1' 7 | q5 q7 0 0 0 | s0 0 0 0 q0. | d1 - 0 0 q0. d0 | - 0 0 0 |
1' q1' q1' q1' q1' q1' q1' | q1' q1' q1' q1' q1' q1' q1' q1' | q1' q1' q1' q1' q1' q1' q1' q1' | q1' q1' 0 0 0 | q5 q7 0 0 0 | s0 0 0 0 q0. | d1 - 0 0 q0. d0 | - 0 0 0 |
%END
%}
...
%% === BEGIN JIANPU STAFF ===
 ...
 \note-mod "4" f'4
 ~  \note-mod "–" f'4  \note-mod "2" d'4  \note-mod "3" e'4 | | %{ bar 3: %} \set stemLeftBeamCount = #0
...
| | %{ bar 6: %}
 ...
 \note-mod "1" c''4^.
 ~  \note-mod "–" c''4  \note-mod "1" c''4^.  \note-mod "7" b'4 | | %{ bar 8: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "5" g'8[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { a'4 r2. | %{ bar 2: %} f'2 d'4 e'4 | | %{ bar 3: %} g'8 b'8 r2. | | %{ bar 4: %} r16 r2. r8. | | %{ bar 5: %} c'32  ~ c'4 r2 r8. r32 | | %{ bar 6: %} R1 | | %{ bar 7: %} c''2 c''4 b'4 | | %{ bar 8: %} g'8 b'8 r2. | | %{ bar 9: %} r16 r2. r8. | | %{ bar 10: %} c'32  ~ c'4 r2 r8. r32 | | %{ bar 11: %} R1 | | %{ bar 12: %} c''4 c''8 c''8 c''8 c''8 c''8 c''8 | | %{ bar 13: %} c''8 c''8 c''8 c''8 c''8 c''8 c''8 c''8 | | %{ bar 14: %} c''8 c''8 c''8 c''8 c''8 c''8 c''8 c''8 | | %{ bar 15: %} c''8 c''8 r2. | | %{ bar 16: %} g'8 b'8 r2. | | %{ bar 17: %} r16 r2. r8. | | %{ bar 18: %} c'32  ~ c'4 r2 r8. r32 | | %{ bar 19: %} r1 | } }
% === END MIDI STAFF ===
