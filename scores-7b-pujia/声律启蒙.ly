...
4/4
5 - 0 0 | q2 - q3 - q6 q0 | - q7 0 0 q0 |
q1' - q2' - q1 q0 | 0 - q1 1 q0 | q1 2 - q1 3 | - q1 4 - q1 | 5 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'2 r2 | | %{ bar 2: %} d'8  ~ d'4 e'8  ~ e'4 a'8 r8 | | %{ bar 3: %} r4 b'8 r2 r8 | | %{ bar 4: %} c''8  ~ c''4 d''8  ~ d''4 c'8 r8 | | %{ bar 5: %} r2 c'8 c'4 r8 | | %{ bar 6: %} c'8 d'2 c'8 e'4  ~ | | %{ bar 7: %} e'4 c'8 f'2 c'8 | | %{ bar 8: %} g'4 r2. | } }
% === END MIDI STAFF ===
