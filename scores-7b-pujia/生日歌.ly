...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 d'8 r2 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} e'8 r2. r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} r4 d'8 r2 r8 | | %{ bar 6: %} R1 | | %{ bar 7: %} e'8 r2. r8 | | %{ bar 8: %} r1 | } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { c'4 r2. | %{ bar 2: %} r4 g'2 r4 | %{ bar 3: %} a'4 c''4 r2 | %{ bar 4: %} b'4 r2. | %{ bar 5: %} f'4 r2. | %{ bar 6: %} a'4. c''4. r4 | %{ bar 7: %} g'4 d'4 r2 | %{ bar 8: %} b'4. c''4. r4 | %{ bar 9: %} b'4 r2. | %{ bar 10: %} b'4 r2. | %{ bar 11: %} a'4 d'8 r2 r8 | %{ bar 12: %} f'2 r2 | %{ bar 13: %} c'4 e'4 r2 | %{ bar 14: %} c''2. r4 | %{ bar 15: %} g'2 r2 | %{ bar 16: %} c'4 a'4 r2 | %{ bar 17: %} e'8 c''4 r2 r8 | %{ bar 18: %} R1 | | %{ bar 19: %} r1 | } }
% === END MIDI STAFF ===
