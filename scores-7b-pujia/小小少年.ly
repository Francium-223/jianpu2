...
4/4
5 - 6 - | 3. 0 0 q0 | q2 - q7 - 0 | q1 - q2 - q3 q0 | 0 0 0 0 |
R{ }
2' - 1' - | 1' 1 0 0 | q6 - q7 - 0 | 0 0 0 0 |
1 3 - 1 | - . 0 0 | q6 - q7 - 0 | 0 0 0 0 |
%END
%}
...
| | %{ bar 5: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \repeat volta 2 { } \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 6: %}
 \note-mod "2" d''4^.
...
\=JianpuTie(  ~ | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 11: %}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'2 a'2 | | %{ bar 2: %} e'4. r2 r8 | | %{ bar 3: %} d'8  ~ d'4 b'8  ~ b'4 r4 | | %{ bar 4: %} c'8  ~ c'4 d'8  ~ d'4 e'8 r8 | | %{ bar 5: %} r1 | \repeat volta 2 { } | %{ bar 6: %} d''2 c''2 | | %{ bar 7: %} c''4 c'4 r2 | | %{ bar 8: %} a'8  ~ a'4 b'8  ~ b'4 r4 | | %{ bar 9: %} R1 | | %{ bar 10: %} c'4 e'2 c'4  ~ | | %{ bar 11: %} c'2 r2 | | %{ bar 12: %} a'8  ~ a'4 b'8  ~ b'4 r4 | | %{ bar 13: %} r1 | } }
% === END MIDI STAFF ===
