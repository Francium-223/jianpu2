...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 c''4 g'2 r4 | | %{ bar 2: %} r4 d'2 e'4  ~ | | %{ bar 3: %} e'4 a'8 b'8 r2 | | %{ bar 4: %} c'8  ~ c'4 r2 r8 | | %{ bar 5: %} c''4 g'2 r4 | | %{ bar 6: %} r4 d'2 e'4  ~ | | %{ bar 7: %} e'4 a'8 b'8 r2 | | %{ bar 8: %} c'8  ~ c'4 r2 r8 | } }
% === END MIDI STAFF ===
