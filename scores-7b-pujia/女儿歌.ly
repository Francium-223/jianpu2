...
4/4
0 5 q6 0 q0 | 3 2 q7 0 q0 | 1' 1' - 0 | 1 2 1' 0 | - - 0 0 | - 0 0 0 |
R{ 5 q6 0 0 q0 }
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 g'4 a'8 r4 r8 | | %{ bar 2: %} e'4 d'4 b'8 r4 r8 | | %{ bar 3: %} c''4 c''2 r4 | | %{ bar 4: %} c'4 d'4 c''4 r4 | | %{ bar 5: %} R1 | | %{ bar 6: %} r1 | \repeat volta 2 { | %{ bar 7: %} g'4 a'8 r2 r8 } } }
% === END MIDI STAFF ===
