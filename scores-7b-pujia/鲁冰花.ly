...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 d'4 e'8  ~ e'4 r4 r8 | | %{ bar 2: %} a'8  ~ a'4 g'2 r8 | | %{ bar 3: %} b'4 c'8 c'8 r2 | | %{ bar 4: %} d''4 r8. c''4 b'4 r16 | | %{ bar 5: %} g'4 r2. | %{ bar 6: %} c'4 e'4 r8. c''4 r16 | | %{ bar 7: %} b'4 g'4 r2 \repeat volta 2 { } } }
% === END MIDI STAFF ===
