...
7 - . q1 q2 | q4 0 0 0 q0
1' - 0 0
1. 5 0 q0 | 1' 1' - 1' | - 0 0 0 |
1' 1' - q2 q3
1' 1' 1' - | q1 q2 q4 0 0 q0
1' - 0 0 | 0 0 0 0 |
R{ }
%END
%}
...
| %{ bar 12: %}
 ...
 ~  \note-mod "–" c''4 | | %{ bar 13: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'4 r2. | | %{ bar 2: %} c''2 r2 | | %{ bar 3: %} R1 | | %{ bar 4: %} a'2 d'8 e'8 r4 | %{ bar 5: %} b'2. c'8 d'8 | | %{ bar 6: %} f'8 r2. r8 | %{ bar 7: %} c''2 r2 | %{ bar 8: %} c'4. g'4 r4 r8 | | %{ bar 9: %} c''4 c''2 c''4  ~ | | %{ bar 10: %} c''4 r2. | | %{ bar 11: %} c''4 c''2 d'8 e'8 | %{ bar 12: %} c''4 c''4 c''2 | | %{ bar 13: %} c'8 d'8 f'8 r2 r8 | %{ bar 14: %} c''2 r2 | | %{ bar 15: %} r1 | \repeat volta 2 { } } }
% === END MIDI STAFF ===
