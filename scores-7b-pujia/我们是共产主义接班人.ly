...
| | %{ bar 4: %}
 ...
 \note-mod "0" r4 | | %{ bar 18: %}
 \note-mod "0" r4
 \note-mod "0" r4 | \repeat volta 2 { } \alternative { { }} \bar "|." } }
% === END JIANPU STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 e'4 g'4 | | %{ bar 2: %} a'4 r4 | | %{ bar 3: %} e'8  ~ e'4 r8 | | %{ bar 4: %} R2 | | %{ bar 5: %} c''2 | | %{ bar 6: %} c''4 r4 | | %{ bar 7: %} R2 | | %{ bar 8: %} r4 c'4 | %{ bar 9: %} R2 | | %{ bar 10: %} b'4 c''4 | | %{ bar 11: %} d''4 r4 | | %{ bar 12: %} R2 | | %{ bar 13: %} R2 | | %{ bar 14: %} R2 | | %{ bar 15: %} b'4 c''4 | | %{ bar 16: %} d''4 r4 | | %{ bar 17: %} R2 | | %{ bar 18: %} r2 | \repeat volta 2 { } \alternative { { }} } }
% === END MIDI STAFF ===
