...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 g'2 | | %{ bar 2: %} e'4 r4 | | %{ bar 3: %} R2 | | %{ bar 4: %} R2 | | %{ bar 5: %} b'8 a'8 r4 | | %{ bar 6: %} R2 | | %{ bar 7: %} c''8 d''8 r4 | | %{ bar 8: %} R2 | | %{ bar 9: %} c'2  ~ | | %{ bar 10: %} c'4 r4 | | %{ bar 11: %} b'8 a'8 r4 | | %{ bar 12: %} R2 | | %{ bar 13: %} c''8 d''8 r4 | | %{ bar 14: %} r2 | } }
% === END MIDI STAFF ===
