...
subtitle=洋娃娃和小熊跳舞
1 0
0 0 | q3 0 q0 | s6 0 q0. | d5 0 q0. d0 | q7 0 q0 | 0 0 |
| | R{ s6 d5 q7 0 d0 }
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 c'4 r4 | %{ bar 2: %} R2 | | %{ bar 3: %} e'8 r4 r8 | | %{ bar 4: %} a'16 r4 r8. | | %{ bar 5: %} g'32 r4 r8. r32 | | %{ bar 6: %} b'8 r4 r8 | | %{ bar 7: %} r2 | | | \repeat volta 2 { | %{ bar 8: %} a'16 g'32 b'8 r4 r32 } } }
% === END MIDI STAFF ===
