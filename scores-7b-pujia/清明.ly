...
5 q2 0 0 q0 | 0 0 0 0 |
q3 - 0 0 q0 | 0 0 0 0 |
6 q7 0 0 q0 | 1 q2 0 0 q0 | 0 0 0 0 |
q3 0 0 0 q0 | 0 0 0 0 |
6 q7 0 0 q0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'4 d'8 r2 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} e'8  ~ e'4 r2 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} a'4 b'8 r2 r8 | | %{ bar 6: %} c'4 d'8 r2 r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} e'8 r2. r8 | | %{ bar 9: %} R1 | | %{ bar 10: %} a'4 b'8 r2 r8 | | %{ bar 11: %} r1 | } }
% === END MIDI STAFF ===
