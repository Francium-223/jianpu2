...
4/4
1' - 0 0 | q5 - 0 0 q0 | s3 - s2 - q6 - | 7 0 0 0 | q1 - 0 0 q0 | q5 - q3 - q2 q0 | - q1 - q5 - | q2 - q1 - 0 | 0 0 0 0 |
q5 - q6 - q3 q0 | - q2 - q1 - | q5 - q4 q3 q2 q1 q0 | 0 0 0 0 |
1' - 0 0 | s5 - s0 0 0 q0 | s3 s2 s7 - 1' 0 s0 | s1 - 0 0 q0. | q5 s3 s2 1 0 0 | 0 0 0 0 |
q6 - q3 - q2 q0 | - q1 - q5 q2 q1 | 0 0 0 0 |
%END
%}
...
\set stemRightBeamCount = #1
 ...
 ~  \note-mod "–" a'4 | | %{ bar 4: %}
 \note-mod "7" b'4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 5: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]  ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 6: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "5" g'8[
...
\set stemRightBeamCount = #1
 \note-mod "5" g'8[]
 ~  \note-mod "–" g'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 8: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "2" d'8[
]  ~  \note-mod "–" d'4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
\set stemRightBeamCount = #1
 \note-mod "1" c'8[]
 ~  \note-mod "–" c'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 12: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "5" g'8[
...
\set stemRightBeamCount = #2
 \note-mod "2" d'16
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 \set stemLeftBeamCount = #2
\set stemRightBeamCount = #2
 \note-mod "7" b'16
]  ~  \note-mod "–" b'4  \note-mod "1" c''4^.  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #2
...
\set stemRightBeamCount = #2
 ...
 \note-mod "1" c'4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 19: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 20: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "6" a'8[
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 c''2 r2 | | %{ bar 2: %} g'8  ~ g'4 r2 r8 | | %{ bar 3: %} e'16  ~ e'4 d'16  ~ d'4 a'8  ~ a'4 | | %{ bar 4: %} b'4 r2. | | %{ bar 5: %} c'8  ~ c'4 r2 r8 | | %{ bar 6: %} g'8  ~ g'4 e'8  ~ e'4 d'8 r8 | | %{ bar 7: %} r4 c'8  ~ c'4 g'8  ~ g'4 | | %{ bar 8: %} d'8  ~ d'4 c'8  ~ c'4 r4 | | %{ bar 9: %} R1 | | %{ bar 10: %} g'8  ~ g'4 a'8  ~ a'4 e'8 r8 | | %{ bar 11: %} r4 d'8  ~ d'4 c'8  ~ c'4 | | %{ bar 12: %} g'8  ~ g'4 f'8 e'8 d'8 c'8 r8 | | %{ bar 13: %} R1 | | %{ bar 14: %} c''2 r2 | | %{ bar 15: %} g'16  ~ g'4 r16 r2 r8 | | %{ bar 16: %} e'16 d'16 b'16  ~ b'4 c''4 r4 r16 | | %{ bar 17: %} c'16  ~ c'4 r2 r8. | | %{ bar 18: %} g'8 e'16 d'16 c'4 r2 | | %{ bar 19: %} R1 | | %{ bar 20: %} a'8  ~ a'4 e'8  ~ e'4 d'8 r8 | | %{ bar 21: %} r4 c'8  ~ c'4 g'8 d'8 c'8 | | %{ bar 22: %} r1 | } }
% === END MIDI STAFF ===
