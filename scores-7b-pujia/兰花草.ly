...
4/4
6 3 0 0 | 1' 3 d3 d3 0 q0. |
d3 0 0 0 q0. d0 | 1' 3 7 0 |
1' 2 1 q5 q0 | 0 - 0 0 |
q1' 1' 0 0 q0 | q1' 0 0 0 q0 |
R{ }
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'4 e'4 r2 | | %{ bar 2: %} c''4 e'4 e'32 e'32 r4 r8. | | %{ bar 3: %} e'32 r2. r8. r32 | | %{ bar 4: %} c''4 e'4 b'4 r4 | | %{ bar 5: %} c''4 d'4 c'4 g'8 r8 | | %{ bar 6: %} R1 | | %{ bar 7: %} c''8 c''4 r2 r8 | | %{ bar 8: %} c''8 r2. r8 | \repeat volta 2 { } } }
% === END MIDI STAFF ===
