...
4 4 0 0
3 5 1' 6 | - 0 0 0 | q2 q7 q1' 0 0 q0 | q2' q0 q1 0 0 q0 | - 1' - 0 | - 2 3 5 | 6 1' 3 2 | 6 0 0 0 | 1' 4 1' 5 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { f'4 f'4 r2 | %{ bar 2: %} e'4 g'4 c''4 a'4  ~ | | %{ bar 3: %} a'4 r2. | | %{ bar 4: %} d'8 b'8 c''8 r2 r8 | | %{ bar 5: %} d''8 r8 c'8 r2 r8 | | %{ bar 6: %} r4 c''2 r4 | | %{ bar 7: %} r4 d'4 e'4 g'4 | | %{ bar 8: %} a'4 c''4 e'4 d'4 | | %{ bar 9: %} a'4 r2. | | %{ bar 10: %} c''4 f'4 c''4 g'4 | } }
% === END MIDI STAFF ===
