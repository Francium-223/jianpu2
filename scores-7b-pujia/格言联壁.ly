...
\set stemRightBeamCount = #1
 \note-mod "4" f'8[
]   \note-mod "4" \once \tweak Accidental.extra-offset #'(0 . 0.7)fes'4
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'4 a'4 b'4 c'4 | | %{ bar 2: %} d'4 e'4 f'8 fes'4 r8 | | %{ bar 3: %} R1 | | %{ bar 4: %} r2 g'8 r4 r8 | | %{ bar 5: %} R1 | | %{ bar 6: %} c''2 r2 | %{ bar 7: %} R1 | | %{ bar 8: %} g'2 c''4 r4 | | %{ bar 9: %} R1 | | %{ bar 10: %} g'1 | | %{ bar 11: %} R1 | | %{ bar 12: %} c''1 | | %{ bar 13: %} R1 | | %{ bar 14: %} g'1 | %{ bar 15: %} c''4 r2. | %{ bar 16: %} g'1 } }
% === END MIDI STAFF ===
