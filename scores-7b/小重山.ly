...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'4 d'8 r2 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} e'8  ~ e'4 r2 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} r4 g'4 c'2 | | %{ bar 6: %} R1 | | %{ bar 7: %} b'8 c''2 r4 r8 | | %{ bar 8: %} R1 | | %{ bar 9: %} c''4 g'4 c''2 | | %{ bar 10: %} R1 | | %{ bar 11: %} d'4 d''2 r4 | | %{ bar 12: %} R1 | | %{ bar 13: %} a'4 d'8 r2 r8 | | %{ bar 14: %} R1 | | %{ bar 15: %} e'8  ~ e'4 r2 r8 | | %{ bar 16: %} R1 | | %{ bar 17: %} r4 g'4 f'2 | | %{ bar 18: %} r1 | } }
% === END MIDI STAFF ===
