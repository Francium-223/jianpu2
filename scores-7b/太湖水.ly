...
2/4
3 - | q6 q7 q1' q2' q0 - q0 | - 0 |
q1 q1 0 | - 0 | 0 0 |
q5 q6 q7 q1' q2' q0 - | - 0 |
q1 q1 0 | - 0 | 0 0 |
q5 q6 q7 q1' q2' q0 - | - 0 |
q2 - q0 | 3. q0 4 5 6 0 7. q0 - 0 |
q2 - q0 | 3 3 - 0 | 0 0 |
q2 - q0 | q3 q4 q5 q6 q7. q1'. q0 | 0 0 |
q1 q1 0 | - 0 | 0 0 |
q1 - q0 | q2 q3 q4 q5 q6 q7. q0. | - 0 |
q0 q0 0 | - 0 | 0 0 |
%END
%}
...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.Stem.transparent = ##t
     \time 2/4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "3" e'4
 ~  \note-mod "–" e'4 | | %{ bar 2: %} \set stemLeftBeamCount = #0
...
| %{ bar 22: %}
 \note-mod "–" r4
 \note-mod "0" r4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 23: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "2" d'8[
]  ~  \note-mod "–" d'4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
\=JianpuTie(  ~ | %{ bar 25: %}
 ...
 \note-mod "0" r4 | | %{ bar 26: %}
 \note-mod "0" r4
 \note-mod "0" r4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 27: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "2" d'8[
]  ~  \note-mod "–" d'4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 e'2 | | %{ bar 2: %} a'8 b'8 c''8 d''8 | %{ bar 3: %} r8 r4 r8 | | %{ bar 4: %} R2 | | %{ bar 5: %} c'8 c'8 r4 | | %{ bar 6: %} R2 | | %{ bar 7: %} R2 | | %{ bar 8: %} g'8 a'8 b'8 c''8 | %{ bar 9: %} d''8 r8 r4 | | %{ bar 10: %} R2 | | %{ bar 11: %} c'8 c'8 r4 | | %{ bar 12: %} R2 | | %{ bar 13: %} R2 | | %{ bar 14: %} g'8 a'8 b'8 c''8 | %{ bar 15: %} d''8 r8 r4 | | %{ bar 16: %} R2 | | %{ bar 17: %} d'8  ~ d'4 r8 | | %{ bar 18: %} e'4. r8 | %{ bar 19: %} f'4 g'4 | %{ bar 20: %} a'4 r4 | %{ bar 21: %} b'4. r8 | %{ bar 22: %} R2 | | %{ bar 23: %} d'8  ~ d'4 r8 | | %{ bar 24: %} e'4 e'4  ~ | %{ bar 25: %} e'4 r4 | | %{ bar 26: %} R2 | | %{ bar 27: %} d'8  ~ d'4 r8 | | %{ bar 28: %} e'8 f'8 g'8 a'8 | %{ bar 29: %} b'8. c''8. r8 | | %{ bar 30: %} R2 | | %{ bar 31: %} c'8 c'8 r4 | | %{ bar 32: %} R2 | | %{ bar 33: %} R2 | | %{ bar 34: %} c'8  ~ c'4 r8 | | %{ bar 35: %} d'8 e'8 f'8 g'8 | %{ bar 36: %} a'8 b'8. r8. | | %{ bar 37: %} R2 | | %{ bar 38: %} r8 r8 r4 | | %{ bar 39: %} R2 | | %{ bar 40: %} r2 | } }
% === END MIDI STAFF ===
