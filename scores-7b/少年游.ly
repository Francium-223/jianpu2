...
4/4
0 5 6 0 | 1' 1' 2 1' | q3 q7 q1' q2' 0 0 | q1 0 q1 1 q1 q0 2 q1 3 0 q0 | 0 0 0 0 |
R{ }
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 g'4 a'4 r4 | | %{ bar 2: %} c''4 c''4 d'4 c''4 | | %{ bar 3: %} e'8 b'8 c''8 d''8 r2 | | %{ bar 4: %} c'8 r4 c'8 c'4 c'8 r8 | %{ bar 5: %} d'4 c'8 e'4 r4 r8 | | %{ bar 6: %} r1 | \repeat volta 2 { } } }
% === END MIDI STAFF ===
