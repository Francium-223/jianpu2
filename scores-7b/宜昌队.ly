...
1' 4 4 0
subtitle=主歌
0 0 0 0 | 2 3 0 0 | q6 5 0 0 q0 | 0 0 0 0 |
0 0 0 0 | 2 3 0 0 | q6 5 0 0 q0 | 0 0 0 0 |
0 0 0 0 | 2 3 0 0 | q6 5 0 0 q0 | 0 0 0 0 |
0 0 0 0 | 2 q5 s1 d1 0 0 d0 | s4 3 2 1 q0. | - 0 0 0 | 0 0 0 0 |
2 0 0 0
NextScore
subtitle=副歌
0 0 0 0 | q6 5 0 0 q0 | q3 3 2 1 q0 | 0 0 0 0 |
0 0 0 0 | q6 5 0 0 q0 | s3 s2 - 0 0 q0 | 0 0 0 0 |
0 0 0 0 | q6 5 0 0 q0 | d4 3 2 1 q0. d0 | - 0 0 0 |
0 0 0 0 | 7 6 5 1 | - - - 0 |
NextScore
subtitle=桥段
0 0 0 0 | 2 q3 0 0 q0 | 0 0 0 0 |
0 0 0 0 | q4 0 0 0 q0 | s6 5 0 0 q0. | 0 0 0 0 |
0 0 0 0 | d1 - 0 0 q0. d0 | 7 d5 1 - q0. d0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { c''4 f'4 f'4 r4 | %{ bar 2: %} R1 | | %{ bar 3: %} d'4 e'4 r2 | | %{ bar 4: %} a'8 g'4 r2 r8 | | %{ bar 5: %} R1 | | %{ bar 6: %} R1 | | %{ bar 7: %} d'4 e'4 r2 | | %{ bar 8: %} a'8 g'4 r2 r8 | | %{ bar 9: %} R1 | | %{ bar 10: %} R1 | | %{ bar 11: %} d'4 e'4 r2 | | %{ bar 12: %} a'8 g'4 r2 r8 | | %{ bar 13: %} R1 | | %{ bar 14: %} R1 | | %{ bar 15: %} d'4 g'8 c'16 c'32 r2 r32 | | %{ bar 16: %} f'16 e'4 d'4 c'4 r8. | | %{ bar 17: %} R1 | | %{ bar 18: %} R1 | | %{ bar 19: %} d'4 r2. } }
% === END MIDI STAFF ===
...
\=JianpuTie(  ~ | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 15: %}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { r1 | | %{ bar 2: %} a'8 g'4 r2 r8 | | %{ bar 3: %} e'8 e'4 d'4 c'4 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} R1 | | %{ bar 6: %} a'8 g'4 r2 r8 | | %{ bar 7: %} e'16 d'16  ~ d'4 r2 r8 | | %{ bar 8: %} R1 | | %{ bar 9: %} R1 | | %{ bar 10: %} a'8 g'4 r2 r8 | | %{ bar 11: %} f'32 e'4 d'4 c'4 r8. r32 | | %{ bar 12: %} R1 | | %{ bar 13: %} R1 | | %{ bar 14: %} b'4 a'4 g'4 c'4  ~ | | %{ bar 15: %} c'2. r4 | } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="b" { r1 | | %{ bar 2: %} d'4 e'8 r2 r8 | | %{ bar 3: %} R1 | | %{ bar 4: %} R1 | | %{ bar 5: %} f'8 r2. r8 | | %{ bar 6: %} a'16 g'4 r2 r8. | | %{ bar 7: %} R1 | | %{ bar 8: %} R1 | | %{ bar 9: %} c'32  ~ c'4 r2 r8. r32 | | %{ bar 10: %} b'4 g'32 c'2 r8. r32 | } }
% === END MIDI STAFF ===
