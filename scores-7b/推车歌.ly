...
6 - 5 - | 0 0 0 0 |
2 q3 0 0 q0 | 0 0 0 0 |
q7 s1' d1 0 0 0 d0 | 0 0 0 0 |
s2' q1 0 q1 0 q1 s0 | 0 0 0 0 | 0 0 0 0 |
q1 0 q1 0 q1 q0 | 0 q1 0 0 q0 | 0 0 0 0 |
q1 0 q1 0 q1 q0 | 0 q1 0 0 q0 | 0 0 0 0 |
q4 - 0 0 q0 | 0 0 0 0 |
2 5 0 0 | 0 0 0 0 |
6 - 7 - | 0 0 0 0 |
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'2 g'2 | | %{ bar 2: %} R1 | | %{ bar 3: %} d'4 e'8 r2 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} b'8 c''16 c'32 r2. r32 | | %{ bar 6: %} R1 | | %{ bar 7: %} d''16 c'8 r4 c'8 r4 c'8 r16 | | %{ bar 8: %} R1 | | %{ bar 9: %} R1 | | %{ bar 10: %} c'8 r4 c'8 r4 c'8 r8 | | %{ bar 11: %} r4 c'8 r2 r8 | | %{ bar 12: %} R1 | | %{ bar 13: %} c'8 r4 c'8 r4 c'8 r8 | | %{ bar 14: %} r4 c'8 r2 r8 | | %{ bar 15: %} R1 | | %{ bar 16: %} f'8  ~ f'4 r2 r8 | | %{ bar 17: %} R1 | | %{ bar 18: %} d'4 g'4 r2 | | %{ bar 19: %} R1 | | %{ bar 20: %} a'2 b'2 | | %{ bar 21: %} R1 | | %{ bar 22: %} a'2 c''4 e'16 r8. | | %{ bar 23: %} r1 | } }
% === END MIDI STAFF ===
