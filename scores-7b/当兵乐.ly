...
4/4
5 - 6 1' - 0 0 0 | 0 0 0 0 |
1' - 2 3 q2 0 0 0 q0 | 0 0 0 0 |
q1 q2 3 q2 0 q0 | 0 0 0 0 |
7 q2 1' q2 0 | 0 0 0 0 |
q2' q0 0 0 0 | 0 0 0 0 |
q1 q2 3 q2 0 q0 | 0 0 0 0 |
%END
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'2 a'4 c''4  ~ | %{ bar 2: %} c''4 r2. | | %{ bar 3: %} R1 | | %{ bar 4: %} c''2 d'4 e'4 | %{ bar 5: %} d'8 r2. r8 | | %{ bar 6: %} R1 | | %{ bar 7: %} c'8 d'8 e'4 d'8 r4 r8 | | %{ bar 8: %} R1 | | %{ bar 9: %} b'4 d'8 c''4 d'8 r4 | | %{ bar 10: %} R1 | | %{ bar 11: %} d''8 r8 r2. | | %{ bar 12: %} R1 | | %{ bar 13: %} c'8 d'8 e'4 d'8 r4 r8 | | %{ bar 14: %} r1 | } }
% === END MIDI STAFF ===
