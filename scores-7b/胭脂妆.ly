...
%% === BEGIN JIANPU STAFF ===
 ...
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 5: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \repeat volta 2 { } \alternative { { } { }} | %{ bar 6: %}
 \note-mod "3" e'4
 \note-mod "5" g'4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 7: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 8: %}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'4 d'2 a'4 | %{ bar 2: %} c'4 d'4 r2 | | %{ bar 3: %} R1 | | %{ bar 4: %} e'4 r2. | | %{ bar 5: %} r1 | \repeat volta 2 { } \alternative { { } { }} | %{ bar 6: %} e'4 g'4 r2 | | %{ bar 7: %} R1 | | %{ bar 8: %} e'4 g'4 r2 | | %{ bar 9: %} r1 | } }
% === END MIDI STAFF ===
