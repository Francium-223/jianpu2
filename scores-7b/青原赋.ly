...
1' 4 4 0
2 0 0 0 | q3 - 0 - q0 5 0 0 0 | q6 q7 1 0 0 | q3 0 0 0 q0 |
R{ } 0 0 0 0 | q6 0 0 0 q0 | q6 0 0 0 q0 |
subtitle=青原赋
1' 4 4 0
2 0 0 0 | q3 - 0 - q0 5 0 0 0 | q6 q7 1 0 0 | q3 0 0 0 q0 |
%END
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { c''4 f'4 f'4 r4 | %{ bar 2: %} d'4 r2. | | %{ bar 3: %} e'8  ~ e'4 r2 r8 | %{ bar 4: %} g'4 r2. | | %{ bar 5: %} a'8 b'8 c'4 r2 | | %{ bar 6: %} e'8 r2. r8 | \repeat volta 2 { } | %{ bar 7: %} R1 | | %{ bar 8: %} a'8 r2. r8 | | %{ bar 9: %} a'8 r2. r8 | | %{ bar 10: %} c''4 f'4 f'4 r4 | %{ bar 11: %} d'4 r2. | | %{ bar 12: %} e'8  ~ e'4 r2 r8 | %{ bar 13: %} g'4 r2. | | %{ bar 14: %} a'8 b'8 c'4 r2 | | %{ bar 15: %} e'8 r2. r8 | } }
% === END MIDI STAFF ===
