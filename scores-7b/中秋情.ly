...
4/4
3 - q2 0 q0 | 0 0 0 0 |
q6 q5 q7 0 0 q0 | 0 0 0 0 |
q1' q1 0 q2' 0 q0 | 0 0 0 0 | 0 0 0 0 |
R{ }
|
R{ }
|
...
| | %{ bar 6: %}
 ...
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 7: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \repeat volta 2 { } | \repeat volta 2 { } | \repeat volta 2 { } | \repeat volta 2 { } | \repeat volta 2 { } | \repeat volta 2 { } | \bar "|." } }
% === END JIANPU STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'2 d'8 r4 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} a'8 g'8 b'8 r2 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} c''8 c'8 r4 d''8 r4 r8 | | %{ bar 6: %} R1 | | %{ bar 7: %} r1 | \repeat volta 2 { } | \repeat volta 2 { } | \repeat volta 2 { } | \repeat volta 2 { } | \repeat volta 2 { } | \repeat volta 2 { } | } }
% === END MIDI STAFF ===
