...
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
\repeat volta 2 { } \alternative { { }} \repeat volta 2 { } \alternative { { }} \bar "|." } }
% === END JIANPU STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'2 a'2 | | %{ bar 2: %} R1 | | %{ bar 3: %} b'4 g'4 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} c'4 d'4. r4 r8 \repeat volta 2 { } \alternative { { }} \repeat volta 2 { } \alternative { { }} } }
% === END MIDI STAFF ===
