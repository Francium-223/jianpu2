...
4/4
0 q2 - 0 q0 | 0 0 0 0 |
q3 - 6 q5 q7 q1' | - 0 0 0 | 0 0 0 0 |
1 q2' q1' q7 q6 0 | - 0 0 0 | 0 0 0 0 |
q5 q4 q3 q2 0 0 | - 0 0 0 | 0 0 0 0 |
7 q1' - 0 q0 | - 0 0 0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 d'8  ~ d'4 r4 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} e'8  ~ e'4 a'4 g'8 b'8 c''8  ~ | | %{ bar 4: %} c''4 r2. | | %{ bar 5: %} R1 | | %{ bar 6: %} c'4 d''8 c''8 b'8 a'8 r4 | | %{ bar 7: %} R1 | | %{ bar 8: %} R1 | | %{ bar 9: %} g'8 f'8 e'8 d'8 r2 | | %{ bar 10: %} R1 | | %{ bar 11: %} R1 | | %{ bar 12: %} b'4 c''8  ~ c''4 r4 r8 | | %{ bar 13: %} R1 | | %{ bar 14: %} r1 | } }
% === END MIDI STAFF ===
