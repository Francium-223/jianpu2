...
\=JianpuTie(  ~ | | %{ bar 3: %}
 ...
 \note-mod "0" r4 | | %{ bar 5: %}
 \note-mod "1" c'4
 \note-mod "7" b'4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 6: %}
 \note-mod "3" e'4
 ~  \note-mod "–" e'4 | %{ bar 7: %}
 \note-mod "5" g'4
 \note-mod "0" r4 | | %{ bar 8: %}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 e'2 | %{ bar 2: %} g'4 a'4  ~ | | %{ bar 3: %} a'4 r4 | | %{ bar 4: %} R2 | | %{ bar 5: %} c'4 b'4 | %{ bar 6: %} e'2 | %{ bar 7: %} g'4 r4 | | %{ bar 8: %} a'4 r4 | | %{ bar 9: %} r2 | } }
% === END MIDI STAFF ===
