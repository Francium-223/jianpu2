...
3 - 2 0 | 6 - 5 0 | 7 1' 1' q1. s0 | 0 0 0 0 |
3 - 2 0 | 6 - 5 0 | 1' q1. 1''. q1. | q1. 0 0 0 s0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r1 | | %{ bar 2: %} e'2 d'4 r4 | | %{ bar 3: %} a'2 g'4 r4 | | %{ bar 4: %} b'4 c''4 c''4 c'8. r16 | | %{ bar 5: %} c''8. r2. r16 | | %{ bar 6: %} R1 | | %{ bar 7: %} e'2 d'4 r4 | | %{ bar 8: %} a'2 g'4 r4 | | %{ bar 9: %} b'4 c''4 c''4 c'8. r16 | | %{ bar 10: %} R1 | | %{ bar 11: %} e'2 d'4 r4 | | %{ bar 12: %} a'2 g'4 r4 | | %{ bar 13: %} c''4 c'8. c'''4. c'8. | | %{ bar 14: %} c'8. r2. r16 | | %{ bar 15: %} r1 | } }
% === END MIDI STAFF ===
