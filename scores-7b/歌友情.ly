...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 d'4 r2. | | %{ bar 2: %} g'4 e'4 r2 | | %{ bar 3: %} R1 | | %{ bar 4: %} R1 | | %{ bar 5: %} b'4 a'4 r2 | | %{ bar 6: %} R1 | | %{ bar 7: %} c'4. r2 r8 | | %{ bar 8: %} r1 | \repeat volta 2 { } \alternative { { } { }} | %{ bar 9: %} c''4 r2. } }
% === END MIDI STAFF ===
