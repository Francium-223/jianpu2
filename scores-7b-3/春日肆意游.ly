...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 c''4 e'4 d'4 g'8 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} b'8 c''8 a'4 g'8 g'4 g'8 | | %{ bar 4: %} R1 | | %{ bar 5: %} c''4 c'4 c'4 g'4 | | %{ bar 6: %} R1 | | %{ bar 7: %} a'4.  ~ a'2 r8 | %{ bar 8: %} c'4. r2 r8 | %{ bar 9: %} d'4. r2 r8 } }
% === END MIDI STAFF ===
