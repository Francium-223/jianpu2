...
7 - 6 0 | q3 s2 - 0 0 s0 |
- - 0 0 | q1 q1 q1 0 0 q0 |
q5 0 0 0 q0 | q3 q3 q3 0 0 q0 |
q0 q0 q0 0 0 q0 | q1 q1 q1 0 0 q0 | 0 0 0 0 |
q1' q2' 0 0 0 | q1 q1 q1 0 0 q0 | 0 0 0 0 |
q4 q7 q6 0 0 q0 | - - - 0 |
q2 q3 q4 0 0 q0 | - - 0 0 |
q2 q3 q4 0 0 q0 | - - 0 0 |
%END
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 b'2 a'4 r4 | | %{ bar 2: %} e'8 d'16  ~ d'4 r2 r16 | | %{ bar 3: %} R1 | | %{ bar 4: %} c'8 c'8 c'8 r2 r8 | | %{ bar 5: %} g'8 r2. r8 | | %{ bar 6: %} e'8 e'8 e'8 r2 r8 | | %{ bar 7: %} r8 r8 r8 r2 r8 | | %{ bar 8: %} c'8 c'8 c'8 r2 r8 | | %{ bar 9: %} R1 | | %{ bar 10: %} c''8 d''8 r2. | | %{ bar 11: %} c'8 c'8 c'8 r2 r8 | | %{ bar 12: %} R1 | | %{ bar 13: %} f'8 b'8 a'8 r2 r8 | | %{ bar 14: %} R1 | | %{ bar 15: %} d'8 e'8 f'8 r2 r8 | | %{ bar 16: %} R1 | | %{ bar 17: %} d'8 e'8 f'8 r2 r8 | | %{ bar 18: %} r1 | } }
% === END MIDI STAFF ===
