...
q3 q2 q7 0 0 q0 | 0 0 0 0 |
q1 q1 q1' 0 0 q0 | 0 0 0 0 |
q1 q1 q5 0 0 q0 | 0 0 0 0 |
q3 q2 - 0 0 | 0 0 0 0 |
q1 q1 q1' 0 0 q0 | 0 0 0 0 |
q1 q1 q5 0 0 q0 | 0 0 0 0 |
q3 q2 - 0 0 | 0 0 0 0 |
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 c''4 g'4 a'4 g'4 | | %{ bar 2: %} c''4 r2. | | %{ bar 3: %} R1 | | %{ bar 4: %} e'8 d'8 b'8 r2 r8 | | %{ bar 5: %} R1 | | %{ bar 6: %} c'8 c'8 c''8 r2 r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} c'8 c'8 g'8 r2 r8 | | %{ bar 9: %} R1 | | %{ bar 10: %} e'8 d'8  ~ d'4 r2 | | %{ bar 11: %} R1 | | %{ bar 12: %} c'8 c'8 c''8 r2 r8 | | %{ bar 13: %} R1 | | %{ bar 14: %} c'8 c'8 g'8 r2 r8 | | %{ bar 15: %} R1 | | %{ bar 16: %} e'8 d'8  ~ d'4 r2 | | %{ bar 17: %} R1 | | %{ bar 18: %} c'8 c'8 c''8 r2 r8 | | %{ bar 19: %} R1 | | %{ bar 20: %} f'8 a'8 r2. | | %{ bar 21: %} r1 | } }
% === END MIDI STAFF ===
