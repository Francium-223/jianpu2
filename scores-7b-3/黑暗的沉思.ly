...
4/4
subtitle=引子
q3 2 - q6 1 | - - q7 q5 - | q1' q2' - 0 0
0 - q6 1 q0 | - - q7 q5 - | - q1' q2' - - | - 0 0 0
q7 q4 - q6 1 q0 | - - - q3 q2 | - q2 q1 - -
q3 2 - q6 0 | - - q7 q5 - | - q1' q2' - -
0 - q6 1 q0 | - - - q7 q4 | - - - -
q7 q4 - - - | - - 0 0
...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.Stem.transparent = ##t
     \time 4/4 \set stemLeftBeamCount = #0
...
\set stemRightBeamCount = #1
 \note-mod "6" a'8[]
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "1" c'4
\=JianpuTie(  ~ | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 2: %}
...
\set stemRightBeamCount = #1
 \note-mod "5" g'8]
 ~  \note-mod "–" g'4 | | %{ bar 3: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c''8^.[
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 \set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
\set stemRightBeamCount = #1
 \note-mod "1" c'8]
 ~ \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "–" c'4
 ~  \note-mod "–" c'4 | %{ bar 11: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "3" e'8[
]  \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "2" d'4
 ~  \note-mod "–" d'4 \set stemLeftBeamCount = #0
...
\set stemRightBeamCount = #1
 \note-mod "4" f'8]
\=JianpuTie(  ~ | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 16: %}
 \note-mod "4" f'4 \=JianpuTie)
 ~ \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "–" f'4
 ~ \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "–" f'4
 ~  \note-mod "–" f'4 | %{ bar 17: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "7" b'8[
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 \set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'8 d'2 a'8 c'4  ~ | | %{ bar 2: %} c'2 b'8 g'8  ~ g'4 | | %{ bar 3: %} c''8 d''8  ~ d''4 r2 | %{ bar 4: %} r2 a'8 c'4 r8 | | %{ bar 5: %} r2 b'8 g'8  ~ g'4  ~ | | %{ bar 6: %} g'4 c''8 d''8  ~ d''2  ~ | | %{ bar 7: %} d''4 r2. | %{ bar 8: %} b'8 f'8  ~ f'4 a'8 c'4 r8 | | %{ bar 9: %} r2. e'8 d'8  ~ | | %{ bar 10: %} d'4 d'8 c'8  ~ c'2 | %{ bar 11: %} e'8 d'2 a'8 r4 | | %{ bar 12: %} r2 b'8 g'8  ~ g'4  ~ | | %{ bar 13: %} g'4 c''8 d''8  ~ d''2 | %{ bar 14: %} r2 a'8 c'4 r8 | | %{ bar 15: %} r2. b'8 f'8  ~ | | %{ bar 16: %} f'1 | %{ bar 17: %} b'8 f'8  ~ f'2.  ~ | | %{ bar 18: %} f'2 r2 } }
% === END MIDI STAFF ===
...
\=JianpuTie(  ~ \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "–" d'4
 ...
 ~  \note-mod "–" b'4  \note-mod "0" r4  \note-mod "0" r4 | %{ bar 5: %}
 \note-mod "0" r4
 \note-mod "–" r4  \note-mod "–" r4  \note-mod "–" r4 | | %{ bar 6: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "6" a'8[
]  \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "1" c'4
 ~ \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "–" c'4
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { \time 4/4 e'4 d'2.  ~ | | %{ bar 2: %} d'4 r2. | %{ bar 3: %} g'2 r2 | %{ bar 4: %} b'2 r2 | %{ bar 5: %} R1 | | %{ bar 6: %} a'8 c'2. r8 | | %{ bar 7: %} r4 b'8 d''8  ~ d''2  ~ | | %{ bar 8: %} d''2 r2 | %{ bar 9: %} c''8 f'8  ~ f'2.  ~ | | %{ bar 10: %} f'2 r2 } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="b" { \time 4/4 e'4 d'2 r4 | %{ bar 2: %} g'2 r2 | %{ bar 3: %} b'2 r2 | %{ bar 4: %} R1 | %{ bar 5: %} c'8  ~ c'2 r4 r8 } }
% === END MIDI STAFF ===
