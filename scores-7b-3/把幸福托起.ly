...
4/4
3 - q7 0 q0 | 1' 6 - - | 5 - 6 0 | 0 0 0 0 |
1' - - 1 | 2. 1' 5 q0 | 6 0 0 0 | 0 0 0 0 |
2 2 3 0
0 3 1 7 | 0 0 0 0 |
7 6 6 - | 1' 5 6 0 | 0 0 0 0 |
3 2 0 0
1 0 0 0 | 3 2 0 0 | 0 0 0 0 |
6 - 5 0
6 - q7 1' q0 | 1 2 0 0 | 0 0 0 0 |
3. 1' 0 q0 | 3 0 0 0 | 0 0 0 0 |
%END
%}
...
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "6" a'4
 ~ \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "–" a'4
 ~  \note-mod "–" a'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 3: %}
 \note-mod "5" g'4
 ~  \note-mod "–" g'4  \note-mod "6" a'4  \note-mod "0" r4 | | %{ bar 4: %}
 \note-mod "0" r4
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'2 b'8 r4 r8 | | %{ bar 2: %} c''4 a'2. | | %{ bar 3: %} g'2 a'4 r4 | | %{ bar 4: %} R1 | | %{ bar 5: %} c''2. c'4 | | %{ bar 6: %} d'4. c''4 g'4 r8 | | %{ bar 7: %} a'4 r2. | | %{ bar 8: %} R1 | | %{ bar 9: %} d'4 d'4 e'4 r4 | %{ bar 10: %} r4 e'4 c'4 b'4 | | %{ bar 11: %} R1 | | %{ bar 12: %} b'4 a'4 a'2 | | %{ bar 13: %} c''4 g'4 a'4 r4 | | %{ bar 14: %} R1 | | %{ bar 15: %} e'4 d'4 r2 | %{ bar 16: %} c'4 r2. | | %{ bar 17: %} e'4 d'4 r2 | | %{ bar 18: %} R1 | | %{ bar 19: %} a'2 g'4 r4 | %{ bar 20: %} a'2 b'8 c''4 r8 | | %{ bar 21: %} c'4 d'4 r2 | | %{ bar 22: %} R1 | | %{ bar 23: %} e'4. c''4 r4 r8 | | %{ bar 24: %} e'4 r2. | | %{ bar 25: %} r1 | } }
% === END MIDI STAFF ===
