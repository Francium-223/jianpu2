...
2/4
5 - | 6 7 | 1' 0 | - 0 | 2' 2 | 3 0 | - 0 | 0 0 | 0 0 |
2 2 | 1 0 | 1' - | 0 0 | 0 0 |
2. q0 | 2 1 | q2 - q2 | - q2 q0 | 0 0 |
2 2 | 1 0 | s2 - s2 q0 | - s2 q0. | 0 0 |
2 2 | 1 0 | d2 - d2 q0. | - d2 q0. d0 | 0 0 |
%END
%}
...
| | %{ bar 16: %}
 \note-mod "2" d'4
 \note-mod "1" c'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 17: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "2" d'8[
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 g'2 | | %{ bar 2: %} a'4 b'4 | | %{ bar 3: %} c''4 r4 | | %{ bar 4: %} R2 | | %{ bar 5: %} d''4 d'4 | | %{ bar 6: %} e'4 r4 | | %{ bar 7: %} R2 | | %{ bar 8: %} R2 | | %{ bar 9: %} R2 | | %{ bar 10: %} d'4 d'4 | | %{ bar 11: %} c'4 r4 | | %{ bar 12: %} c''2 | | %{ bar 13: %} R2 | | %{ bar 14: %} R2 | | %{ bar 15: %} d'4. r8 | | %{ bar 16: %} d'4 c'4 | | %{ bar 17: %} d'8  ~ d'4 d'8  ~ | | %{ bar 18: %} d'4 d'8 r8 | | %{ bar 19: %} R2 | | %{ bar 20: %} d'4 d'4 | | %{ bar 21: %} c'4 r4 | | %{ bar 22: %} d'16  ~ d'4 d'16 r8 | | %{ bar 23: %} r4 d'16 r8. | | %{ bar 24: %} R2 | | %{ bar 25: %} d'4 d'4 | | %{ bar 26: %} c'4 r4 | | %{ bar 27: %} d'32  ~ d'4 d'32 r8. | | %{ bar 28: %} r4 d'32 r8. r32 | | %{ bar 29: %} r2 | } }
% === END MIDI STAFF ===
