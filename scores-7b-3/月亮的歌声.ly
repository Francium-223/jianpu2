...
1' 2 4 0
3 5 - - | q6 q7 q7 0 0 q0 | 0 0 0 0 |
q1' q7 q7 0 0 q0 | q1 0 q2' q2' 0 q0 | 0 0 0 0 |
q1' q7 q7 0 0 q0 | q1 0 q2' q2' 0 q0 | 0 0 0 0 |
q1' q7 q7 0 0 q0 | q1 0 q2' q2' 0 q0 | 0 0 0 0 |
q1' q7 q7 0 0 q0 | q1 2 - - q0 | 0 0 0 0 |
q6 q5 q3 0 0 q0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { c''4 d'4 f'4 r4 | %{ bar 2: %} e'4 g'2. | | %{ bar 3: %} a'8 b'8 b'8 r2 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} c''8 b'8 b'8 r2 r8 | | %{ bar 6: %} c'8 r4 d''8 d''8 r4 r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} c''8 b'8 b'8 r2 r8 | | %{ bar 9: %} c'8 r4 d''8 d''8 r4 r8 | | %{ bar 10: %} R1 | | %{ bar 11: %} c''8 b'8 b'8 r2 r8 | | %{ bar 12: %} c'8 r4 d''8 d''8 r4 r8 | | %{ bar 13: %} R1 | | %{ bar 14: %} c''8 b'8 b'8 r2 r8 | | %{ bar 15: %} c'8 d'2. r8 | | %{ bar 16: %} R1 | | %{ bar 17: %} a'8 g'8 e'8 r2 r8 | | %{ bar 18: %} r1 | } }
% === END MIDI STAFF ===
