...
4/4
2 q3 q5 q6 0 q0 | 0 0 0 0 |
q7 q1' q2' q1 0 0 | 0 0 0 0 |
q1 - 1' 1' q0 | 0 0 0 0 |
q1' q2 q3 q4 0 0 | 0 0 0 0 |
q5 q6 q7 q1' 0 0 | 0 0 0 0 |
q2' q1 0 q1 1 q1 | 2 0 0 0
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 d'4 e'8 g'8 a'8 r4 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} b'8 c''8 d''8 c'8 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} c'8  ~ c'4 c''4 c''4 r8 | | %{ bar 6: %} R1 | | %{ bar 7: %} c''8 d'8 e'8 f'8 r2 | | %{ bar 8: %} R1 | | %{ bar 9: %} g'8 a'8 b'8 c''8 r2 | | %{ bar 10: %} R1 | | %{ bar 11: %} d''8 c'8 r4 c'8 c'4 c'8 | | %{ bar 12: %} d'4 r2. } }
% === END MIDI STAFF ===
