...
4/4
6' q2 s3 d5 q7 q1 - d0 | 0 0 0 0 |
R{ } A{ | }
d6 q0. q1' q2' - - d0 | - 0 0 0
q2 4' q2 s3 d5 q7 q1 q0 d0 | - 0 0 0
%END
%}
...
| | %{ bar 2: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \repeat volta 2 { } \alternative { { } { }} | %{ bar 3: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #3
 \note-mod "6" a'32[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a''4 d'8 e'16 g'32 b'8 c'8  ~ c'4 r32 | | %{ bar 2: %} r1 | \repeat volta 2 { } \alternative { { } { }} | %{ bar 3: %} a'32 r8. c''8 d''8  ~ d''2 r32 | | %{ bar 4: %} R1 | %{ bar 5: %} d'8 f''4 d'8 e'16 g'32 b'8 c'8 r8 r32 | | %{ bar 6: %} r1 } }
% === END MIDI STAFF ===
