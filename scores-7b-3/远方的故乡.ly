...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r2 g'8 r4 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} d'8 e'4 a'8 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} c'2 b'16 r4 r8. | | %{ bar 6: %} R1 | | %{ bar 7: %} c''16  ~ c''4 d''4 r4 r8. | | %{ bar 8: %} R1 | | %{ bar 9: %} r4 a'8 r2 r8 | | %{ bar 10: %} R1 | | %{ bar 11: %} d'8 c''4 c''4 a'4 r8 | | %{ bar 12: %} R1 | | %{ bar 13: %} r4 a'8 r2 r8 | | %{ bar 14: %} R1 | | %{ bar 15: %} d'8 r2. r8 | | %{ bar 16: %} r1 | } }
% === END MIDI STAFF ===
