...
4/4
5 - 6 3 | - 2 0 0 | q7 q7 q7 q7 0 0 | q1 - 0 0 q0 |
1' - 2' 0 | - 0 0 0 | q7 q7 q7 q7 0 0 | 0 0 0 0 |
5 - 6 3 | - 2 0 0 | q7 q7 q7 q7 0 0 | 0 0 0 0 |
4 - 5 - | 1' - 0 0 |
5 - 6 1 | - - 0 0 | 1' - 0 0 |
1' - 2' 0 | - 0 0 0 | q7 q7 q7 q7 0 0 | 0 0 0 0 |
...
\set stemRightBeamCount = #1
 ...
 ~  \note-mod "–" g'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 14: %}
 \note-mod "1" c''4^.
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'2 a'4 e'4  ~ | | %{ bar 2: %} e'4 d'4 r2 | | %{ bar 3: %} b'8 b'8 b'8 b'8 r2 | | %{ bar 4: %} c'8  ~ c'4 r2 r8 | | %{ bar 5: %} c''2 d''4 r4 | | %{ bar 6: %} R1 | | %{ bar 7: %} b'8 b'8 b'8 b'8 r2 | | %{ bar 8: %} R1 | | %{ bar 9: %} g'2 a'4 e'4  ~ | | %{ bar 10: %} e'4 d'4 r2 | | %{ bar 11: %} b'8 b'8 b'8 b'8 r2 | | %{ bar 12: %} R1 | | %{ bar 13: %} f'2 g'2 | | %{ bar 14: %} c''2 r2 | | %{ bar 15: %} g'2 a'4 c'4  ~ | | %{ bar 16: %} c'2 r2 | | %{ bar 17: %} c''2 r2 | | %{ bar 18: %} c''2 d''4 r4 | | %{ bar 19: %} R1 | | %{ bar 20: %} b'8 b'8 b'8 b'8 r2 | | %{ bar 21: %} R1 | | %{ bar 22: %} e'2 d'2  ~ | | %{ bar 23: %} d'4 r2. | | %{ bar 24: %} R1 | | %{ bar 25: %} R1 | | %{ bar 26: %} R1 | | %{ bar 27: %} R1 | | %{ bar 28: %} c''4 a'4 r2 | | %{ bar 29: %} g'4.  ~ g'4 r4 r8 | | %{ bar 30: %} c''2 r2 | | %{ bar 31: %} c'8 c'8 c'8 r8 r2 | %{ bar 32: %} c''2 r2 } }
% === END MIDI STAFF ===
