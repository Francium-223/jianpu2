...
2 3 2 6 | 0 0 0 0 |
6 2 0 0 | 0 0 0 0 |
1 2 1. q0 | 6 0 0 0 | - 0 0 0 |
6 5 6 1' | 1' 3 0 0 | 0 0 0 0 |
6 5 6 1' | 0 0 0 0 |
5 - - 0
5 - 0 0
2 2 3 q5 q6 | 1' 0 0 0 | 0 0 0 0 |
3 3 - 0 | - 0 0 0 |
5 3 0 0
5 0 0 0
5. 0 0 q0
...
| | %{ bar 17: %}
 ...
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 19: %}
 \note-mod "6" a'4
 \note-mod "5" g'4  \note-mod "6" a'4  \note-mod "1" c''4^. | | %{ bar 20: %}
 \note-mod "1" c''4^.
 \note-mod "3" e'4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 21: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 22: %}
 \note-mod "6" a'4
 \note-mod "5" g'4  \note-mod "6" a'4  \note-mod "1" c''4^. | | %{ bar 23: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 24: %}
 \note-mod "5" g'4
 ~ \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "–" g'4
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'4 g'4 a'4 c''4 | | %{ bar 2: %} c''4 e'4 r2 | | %{ bar 3: %} R1 | | %{ bar 4: %} a'4 g'4 a'4 c''4 | | %{ bar 5: %} R1 | | %{ bar 6: %} c'2. r4 | | %{ bar 7: %} R1 | | %{ bar 8: %} d'4 r2. | | %{ bar 9: %} R1 | | %{ bar 10: %} e'4 d'8 g'8 r2 | | %{ bar 11: %} R1 | | %{ bar 12: %} d'4 e'4 d'4 a'4 | | %{ bar 13: %} R1 | | %{ bar 14: %} a'4 d'4 r2 | | %{ bar 15: %} R1 | | %{ bar 16: %} c'4 d'4 c'4. r8 | | %{ bar 17: %} a'4 r2. | | %{ bar 18: %} R1 | | %{ bar 19: %} a'4 g'4 a'4 c''4 | | %{ bar 20: %} c''4 e'4 r2 | | %{ bar 21: %} R1 | | %{ bar 22: %} a'4 g'4 a'4 c''4 | | %{ bar 23: %} R1 | | %{ bar 24: %} g'2. r4 | %{ bar 25: %} g'2 r2 | %{ bar 26: %} d'4 d'4 e'4 g'8 a'8 | | %{ bar 27: %} c''4 r2. | | %{ bar 28: %} R1 | | %{ bar 29: %} e'4 e'2 r4 | | %{ bar 30: %} R1 | | %{ bar 31: %} g'4 e'4 r2 | %{ bar 32: %} g'4 r2. | %{ bar 33: %} g'4. r2 r8 | %{ bar 34: %} g'4 r2. } }
% === END MIDI STAFF ===
