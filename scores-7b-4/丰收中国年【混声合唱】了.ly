...
4/4
subtitle=丰收中国年
0 q5 0 0 q0 | 1' 2 1' 6 | 1' 3 - 0 | 0 0 0 0 |
1' 1 q2 0 q0 | b7 q1' 0 0 q0 | q2' 0 0 0 q0 |
q1. q2 0 0 q0. | q3 s3 0 0 0 s0 | d3 3' 0 0 q0. d0 | 0 0 0 0 |
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 g'8 r2 r8 | | %{ bar 2: %} c''4 d'4 c''4 a'4 | | %{ bar 3: %} c''4 e'2 r4 | | %{ bar 4: %} R1 | | %{ bar 5: %} c''4 c'4 d'8 r4 r8 | | %{ bar 6: %} bes'4 c''8 r2 r8 | | %{ bar 7: %} d''8 r2. r8 | | %{ bar 8: %} c'8. d'8 r2 r8. | | %{ bar 9: %} e'8 e'16 r2. r16 | | %{ bar 10: %} e'32 e''4 r2 r8. r32 | | %{ bar 11: %} R1 | | %{ bar 12: %} d''2 r2 | | %{ bar 13: %} R1 | | %{ bar 14: %} R1 | | %{ bar 15: %} r1 | } }
% === END MIDI STAFF ===
