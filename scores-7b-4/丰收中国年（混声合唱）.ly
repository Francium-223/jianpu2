...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 d'8 r2 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} g'8  ~ g'4 r2 r8 } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { b'8  ~ b'4 r2 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} a'8 r2. r8 | | %{ bar 4: %} r1 | } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="b" { e'8  ~ e'4 r2 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} c'8 r2. r8 | | %{ bar 4: %} r1 | } }
% === END MIDI STAFF ===
