...
4/4
1' 0 0 0
2 - q3 0 q0 | d6 0 0 0 q0. d0 | 0 0 0 0 |
1' 5 0 0
subtitle=副歌层
NextScore
1' 0 0 0
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 c''4 r2. | %{ bar 2: %} d'2 e'8 r4 r8 | | %{ bar 3: %} a'32 r2. r8. r32 | | %{ bar 4: %} R1 | | %{ bar 5: %} c''4 g'4 r2 } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { c''4 r2. | %{ bar 2: %} d'2 e'8 r4 r8 | | %{ bar 3: %} a'32 r2. r8. r32 | | %{ bar 4: %} R1 | | %{ bar 5: %} d''4 r2. } }
% === END MIDI STAFF ===
