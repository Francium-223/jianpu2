...
2/4
1' 0 | q3 q2 0 | 1' - | - 0 | 1' - | 1' 5 | - 0 |
1' - | 1' 0 | q1' - q2 | 1' - | - q1' q0 | - - |
1 1' | q1' 5 q0 | 3 0 | - 0 | 0. q0 | 2 - | 6. q0 | - 0 | 7. q0 |
%END
%}
...
| | %{ bar 13: %}
 ...
 \note-mod "–" r4 | | %{ bar 14: %}
 \note-mod "1" c'4
 \note-mod "1" c''4^. | | %{ bar 15: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c''8^.[
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 c''4 r4 | | %{ bar 2: %} e'8 d'8 r4 | | %{ bar 3: %} c''2  ~ | | %{ bar 4: %} c''4 r4 | | %{ bar 5: %} c''2 | | %{ bar 6: %} c''4 g'4  ~ | | %{ bar 7: %} g'4 r4 | | %{ bar 8: %} c''2 | | %{ bar 9: %} c''4 r4 | | %{ bar 10: %} c''8  ~ c''4 d'8 | | %{ bar 11: %} c''2  ~ | | %{ bar 12: %} c''4 c''8 r8 | | %{ bar 13: %} R2 | | %{ bar 14: %} c'4 c''4 | | %{ bar 15: %} c''8 g'4 r8 | | %{ bar 16: %} e'4 r4 | | %{ bar 17: %} R2 | | %{ bar 18: %} r4. r8 | | %{ bar 19: %} d'2 | | %{ bar 20: %} a'4. r8 | | %{ bar 21: %} R2 | | %{ bar 22: %} b'4. r8 | } }
% === END MIDI STAFF ===
