...
4/4
0 6 q3 5 q7 | 2 q6 0 0 q0 | q4 q3 1 - - | 0 - 0 0 | 0 0 0 0 | 1 2 3 5 | 0 0 0 0 |
1 2 3 5 | 0 0 0 0 |
0 6 q3 5 q7 | 2 q6 0 0 q0 | q4 q3 1 2 s2 s2 q0 | - 0 - 0 | 0 0 0 0 | 1 2 3 5 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 a'4 e'8 g'4 b'8 | | %{ bar 2: %} d'4 a'8 r2 r8 | | %{ bar 3: %} f'8 e'8 c'2. | | %{ bar 4: %} R1 | | %{ bar 5: %} R1 | | %{ bar 6: %} c'4 d'4 e'4 g'4 | | %{ bar 7: %} R1 | | %{ bar 8: %} c'4 d'4 e'4 g'4 | | %{ bar 9: %} R1 | | %{ bar 10: %} r4 a'4 e'8 g'4 b'8 | | %{ bar 11: %} d'4 a'8 r2 r8 | | %{ bar 12: %} f'8 e'8 c'4 d'4 d'16 d'16 r8 | | %{ bar 13: %} R1 | | %{ bar 14: %} R1 | | %{ bar 15: %} c'4 d'4 e'4 g'4 | | %{ bar 16: %} r1 | } }
% === END MIDI STAFF ===
