...
4/4
3 6 q5 1' q0 | 2 0 0 0 | 0 0 0 0 |
q6 q7 q1' q2' 0 0 | 0 0 0 0 |
1 0 - 1 | 1 - 1 2 | - 1 3 0 | 0 0 0 0 |
1 4 - 1 | 5 - 1 6 | - 1 7 0 | 0 0 0 0 |
1 1' - 1 | 2' - 2 0 | 0 0 0 0 |
%END
%}
...
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "4" f'4
 ~  \note-mod "–" f'4  \note-mod "1" c'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 11: %}
 \note-mod "5" g'4
 ~  \note-mod "–" g'4  \note-mod "1" c'4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "6" a'4
\=JianpuTie(  ~ | | %{ bar 12: %}
 ...
 \note-mod "1" c'4
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "1" c''4^.
 ~  \note-mod "–" c''4  \note-mod "1" c'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 15: %}
 \note-mod "2" d''4^.
 ~  \note-mod "–" d''4  \note-mod "2" d'4  \note-mod "0" r4 | | %{ bar 16: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \bar "|." } }
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'4 a'4 g'8 c''4 r8 | | %{ bar 2: %} d'4 r2. | | %{ bar 3: %} R1 | | %{ bar 4: %} a'8 b'8 c''8 d''8 r2 | | %{ bar 5: %} R1 | | %{ bar 6: %} c'4 r2 c'4 | | %{ bar 7: %} c'2 c'4 d'4  ~ | | %{ bar 8: %} d'4 c'4 e'4 r4 | | %{ bar 9: %} R1 | | %{ bar 10: %} c'4 f'2 c'4 | | %{ bar 11: %} g'2 c'4 a'4  ~ | | %{ bar 12: %} a'4 c'4 b'4 r4 | | %{ bar 13: %} R1 | | %{ bar 14: %} c'4 c''2 c'4 | | %{ bar 15: %} d''2 d'4 r4 | | %{ bar 16: %} r1 | } }
% === END MIDI STAFF ===
