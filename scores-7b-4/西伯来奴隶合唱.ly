...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { e'4 d'4 r2 | | %{ bar 2: %} g'4 r2. | | %{ bar 3: %} R1 | | %{ bar 4: %} R1 | | %{ bar 5: %} f'4 b'4 d'4 r4 | | %{ bar 6: %} R1 | | %{ bar 7: %} R1 | | %{ bar 8: %} a'4 r2. | | %{ bar 9: %} R1 | | %{ bar 10: %} r1 | \repeat volta 2 { } \alternative { { } { }} | %{ bar 11: %} c'4 f'4 f'4 r4 | %{ bar 12: %} c''4 c''4 d''4 r4 | %{ bar 13: %} f'4 c''4 g'4 r4 } }
% === END MIDI STAFF ===
