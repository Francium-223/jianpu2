...
4/4
6 5 0 0 | q3 2 - 0 q0 | 0 0 0 0 |
6 1 - 0 | 0 0 0 0 |
6 5 0 0 | q3 2 - 0 q0 | 0 0 0 0 |
6 1 - 0 | 0 0 0 0 |
5 6 7 1' | 2' 0 0 0 | 0 0 0 0 |
2 q3 2 0 q0 | - 0 0 0 | 0 0 0 0 |
2 q3 2 - q0 | 0 0 0 0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'4 g'4 r2 | | %{ bar 2: %} e'8 d'2 r4 r8 | | %{ bar 3: %} R1 | | %{ bar 4: %} a'4 c'2 r4 | | %{ bar 5: %} R1 | | %{ bar 6: %} a'4 g'4 r2 | | %{ bar 7: %} e'8 d'2 r4 r8 | | %{ bar 8: %} R1 | | %{ bar 9: %} a'4 c'2 r4 | | %{ bar 10: %} R1 | | %{ bar 11: %} g'4 a'4 b'4 c''4 | | %{ bar 12: %} d''4 r2. | | %{ bar 13: %} R1 | | %{ bar 14: %} d'4 e'8 d'4 r4 r8 | | %{ bar 15: %} R1 | | %{ bar 16: %} R1 | | %{ bar 17: %} d'4 e'8 d'2 r8 | | %{ bar 18: %} R1 | | %{ bar 19: %} r1 | } }
% === END MIDI STAFF ===
