...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'4 a'4 b'4 c''4 | | %{ bar 2: %} c''4 e'8 r2 r8 | | %{ bar 3: %} R1 | | %{ bar 4: %} d'8  ~ d'4 r2 r8 | | %{ bar 5: %} R1 | | %{ bar 6: %} c'8 r2. r8 | %{ bar 7: %} g'4 g'4 g'4 r4 | | %{ bar 8: %} R1 | | %{ bar 9: %} d'4 c'4 r2 | %{ bar 10: %} g'4 a'4 r2 | | %{ bar 11: %} r1 | } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { c'4. c''4 e'8 r4 | | %{ bar 2: %} R1 | | %{ bar 3: %} d'8  ~ d'4 r2 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} b'8 a'4 r2 r8 } }
% === END MIDI STAFF ===
