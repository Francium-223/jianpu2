...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'2 e'4 d'4 | | %{ bar 2: %} R1 | | %{ bar 3: %} e'4 d'4 c'2 | | %{ bar 4: %} R1 | | %{ bar 5: %} R1 | | %{ bar 6: %} a'4 b'4 c''4 r4 | | %{ bar 7: %} R1 | | %{ bar 8: %} a'4 b'4 c''4 r4 | | %{ bar 9: %} R1 | | %{ bar 10: %} a'4 b'4 c''4 r4 | | %{ bar 11: %} R1 | | %{ bar 12: %} a'4 b'4 c''4 r4 | | %{ bar 13: %} r1 | } }
% === END MIDI STAFF ===
