...
4/4
3 q2 q7 q6 q5 q1' q2' | q1 0 q1 1 q1 q0 | 2 q1 3 0 q0
R{ } A{ | }
subtitle=opt.
q2 q7 q6 q5 q1' q2' q1 q0 | 0 q1 1 q1 2 | q1 3 0 0 q0
%END
%}
...
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
\repeat volta 2 { } \alternative { { } { }} | %{ bar 4: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "2" d'8[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
\set stemRightBeamCount = #1
 \note-mod "1" c'8[]
 \note-mod "2" d'4 | | %{ bar 6: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "1" c'8[
]   \note-mod "3" e'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'4 d'8 b'8 a'8 g'8 c''8 d''8 | | %{ bar 2: %} c'8 r4 c'8 c'4 c'8 r8 | | %{ bar 3: %} d'4 c'8 e'4 r4 r8 \repeat volta 2 { } \alternative { { } { }} | %{ bar 4: %} d'8 b'8 a'8 g'8 c''8 d''8 c'8 r8 | | %{ bar 5: %} r4 c'8 c'4 c'8 d'4 | | %{ bar 6: %} c'8 e'4 r2 r8 } }
% === END MIDI STAFF ===
