...
6/8
3 2 0 | q4 q4 0 0 | 5 - - | - 0 0 | - 0 0 | 0 0 0 |
6. 7 q0 | 1'' 2 0 | 1' - 0 | 1'. 0 q0 | 3 3 3 | 2 3 2 | 1 0 0 | 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 6/8 e'4 d'4 r4 | | %{ bar 2: %} f'8 f'8 r2 | | %{ bar 3: %} g'2.  ~ | | %{ bar 4: %} g'4 r2 | | %{ bar 5: %} R2. | | %{ bar 6: %} R2. | | %{ bar 7: %} a'4. b'4 r8 | | %{ bar 8: %} c'''4 d'4 r4 | | %{ bar 9: %} c''2 r4 | | %{ bar 10: %} c''4. r4 r8 | | %{ bar 11: %} e'4 e'4 e'4 | | %{ bar 12: %} d'4 e'4 d'4 | | %{ bar 13: %} c'4 r2 | | %{ bar 14: %} r2. | } }
% === END MIDI STAFF ===
