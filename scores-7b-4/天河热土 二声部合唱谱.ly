...
4/4
3 2 0 0 | 1' - 6 5 | 2 3 0 0 | 0 0 0 0 |
1' - - 0 | 3. 2 0 q0 | 0 0 0 0 |
1' - - 3 | 1 6 1' 0 | 0 0 0 0 |
5 - - - | 5' 2 3' 0
5' 1' 2' 0
0 0 0 0 | 0 0 0 0 |
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'4 d'4 r2 | | %{ bar 2: %} c''2 a'4 g'4 | | %{ bar 3: %} d'4 e'4 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} c''2. r4 | | %{ bar 6: %} e'4. d'4 r4 r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} c''2. e'4 | | %{ bar 9: %} c'4 a'4 c''4 r4 | | %{ bar 10: %} R1 | | %{ bar 11: %} g'1 | | %{ bar 12: %} g''4 d'4 e''4 r4 | %{ bar 13: %} g''4 c''4 d''4 r4 | %{ bar 14: %} R1 | | %{ bar 15: %} R1 | | %{ bar 16: %} a'4 a'4 a'4 c''4 | %{ bar 17: %} a'4 c''4 d'4 r4 | %{ bar 18: %} d'4 f'4 r2 | | %{ bar 19: %} R1 | | %{ bar 20: %} r1 | } }
% === END MIDI STAFF ===
