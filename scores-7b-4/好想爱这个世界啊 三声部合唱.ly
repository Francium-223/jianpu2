...
4/4
1' 0 0 0
0 7 1' 5 | 1' 5 0 0 | q3 q2 q1 - 0 q0 |
3 - 2 0 | 0 0 0 0 | 0 0 0 0 |
6 - 5 0 | 0 0 0 0 | 0 0 0 0 |
6 - 5 0 | - 0 0 0 | 0 0 0 0 |
3 2 4 3 | 1 - 0 0 |
5 7 1' 2' | q0 q1 0 0 0 |
5 - 0 0 | q3 q2 q1 0 0 q0 | 0 0 0 0 |
1'. 0 0 q0
R{ }
%END
%}
...
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 5: %}
 ...
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 14: %}
 \note-mod "3" e'4
 \note-mod "2" d'4  \note-mod "4" f'4  \note-mod "3" e'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 15: %}
 \note-mod "1" c'4
 ~  \note-mod "–" c'4  \note-mod "0" r4  \note-mod "0" r4 | | %{ bar 16: %}
 \note-mod "5" g'4
 \note-mod "7" b'4  \note-mod "1" c''4^.  \note-mod "2" d''4^. | | %{ bar 17: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "0" c'8[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 c''4 r2. | %{ bar 2: %} r4 b'4 c''4 g'4 | | %{ bar 3: %} c''4 g'4 r2 | | %{ bar 4: %} e'8 d'8 c'8  ~ c'4 r4 r8 | | %{ bar 5: %} e'2 d'4 r4 | | %{ bar 6: %} R1 | | %{ bar 7: %} R1 | | %{ bar 8: %} a'2 g'4 r4 | | %{ bar 9: %} R1 | | %{ bar 10: %} R1 | | %{ bar 11: %} a'2 g'4 r4 | | %{ bar 12: %} R1 | | %{ bar 13: %} R1 | | %{ bar 14: %} e'4 d'4 f'4 e'4 | | %{ bar 15: %} c'2 r2 | | %{ bar 16: %} g'4 b'4 c''4 d''4 | | %{ bar 17: %} r8 c'8 r2. | | %{ bar 18: %} g'2 r2 | | %{ bar 19: %} e'8 d'8 c'8 r2 r8 | | %{ bar 20: %} R1 | | %{ bar 21: %} c''4. r2 r8 \repeat volta 2 { } } }
% === END MIDI STAFF ===
