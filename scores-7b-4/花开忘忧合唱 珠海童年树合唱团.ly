...
| | %{ bar 8: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | \repeat volta 2 { } \alternative { { } { }} | %{ bar 9: %}
 \note-mod "1" c''4^.
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "2" d'8[
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r4 d'8 r2 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} e'8 a'16 b'32 r2. r32 | | %{ bar 4: %} R1 | | %{ bar 5: %} g'16  ~ g'2 r4 r8. | | %{ bar 6: %} R1 | | %{ bar 7: %} c''4 d'8 r2 r8 | | %{ bar 8: %} r1 | \repeat volta 2 { } \alternative { { } { }} | %{ bar 9: %} c''4 d'8 r2 r8 | | %{ bar 10: %} R1 | | %{ bar 11: %} e'8 a'16 b'32 r2. r32 | | %{ bar 12: %} R1 | | %{ bar 13: %} g'16  ~ g'4 r2 r8. | %{ bar 14: %} c''4 d'8 r2 r8 | | %{ bar 15: %} r1 | } }
% === END MIDI STAFF ===
