...
subtitle=南湖的船，党的摇篮
q2 q3 - 0 0 | 0 0 0 0 |
q1 q7 q6 d5 q1' 0 q0. d0 | 0 0 0 0 |
6 5 4 0
6 5 4 0
d6 5 b4 0 q0. d0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 d'8 e'8  ~ e'4 r2 | | %{ bar 2: %} R1 | | %{ bar 3: %} c'8 b'8 a'8 g'32 c''8 r4 r8. r32 | | %{ bar 4: %} R1 | | %{ bar 5: %} a'4 g'4 f'4 r4 | %{ bar 6: %} a'4 g'4 f'4 r4 | %{ bar 7: %} a'32 g'4 fes'4 r4 r8. r32 | | %{ bar 8: %} r1 | } }
% === END MIDI STAFF ===
