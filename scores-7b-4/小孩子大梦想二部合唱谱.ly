...
subtitle=小孩子大梦想
q2 q3 - 0 0 | 0 0 0 0 |
q1 q7 q6 q5 q1' q2' q0 q1 | 0 0 0 0 |
q2 q3 0 0 0 | 0 0 0 0 |
q1 q7 q6 q5 q1' q2' q0 q1 | 0 0 0 0 |
%END
%}
...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.Stem.transparent = ##t
     \time 4/4 \tempo 4=85 \set stemLeftBeamCount = #0
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 \tempo 4=85 d'8 e'8  ~ e'4 r2 | | %{ bar 2: %} R1 | | %{ bar 3: %} c'8 b'8 a'8 g'8 c''8 d''8 r8 c'8 | | %{ bar 4: %} R1 | | %{ bar 5: %} d'8 e'8 r2. | | %{ bar 6: %} R1 | | %{ bar 7: %} c'8 b'8 a'8 g'8 c''8 d''8 r8 c'8 | | %{ bar 8: %} r1 | } }
% === END MIDI STAFF ===
