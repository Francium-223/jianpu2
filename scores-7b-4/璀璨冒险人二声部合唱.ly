...
4/4
subtitle=二声部合唱
5 q7 q6 q2 0 q0 | 0 0 0 0 |
|
1' q1 q1 q1 q1 q1 q1 | q1 q1 0 0 0
4 2' q1 q1 q7 q6 | q2 0 0 0 q0 | 0 0 0 0 |
NextScore
subtitle=副歌
5 q3 - - q0 | - 0 0 0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'4 b'8 a'8 d'8 r4 r8 | | %{ bar 2: %} R1 | | | %{ bar 3: %} c''4 c'8 c'8 c'8 c'8 c'8 c'8 | | %{ bar 4: %} c'8 c'8 r2. | %{ bar 5: %} f'4 d''4 c'8 c'8 b'8 a'8 | | %{ bar 6: %} d'8 r2. r8 | | %{ bar 7: %} r1 | } }
% === END MIDI STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Z" { g'4 e'8  ~ e'2 r8 | | %{ bar 2: %} R1 | | %{ bar 3: %} r1 | } }
% === END MIDI STAFF ===
