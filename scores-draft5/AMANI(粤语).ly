...
\=JianpuTie(  ~ \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "–" b'4
 ...
 \note-mod "0" r4 |  \note-mod "–" r4  \note-mod "3" e'4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 5: %}
 \note-mod "4" f'4
...
|  \note-mod "2" d'4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "3" e'4
 ~  \note-mod "–" e'4 | | %{ bar 8: %}
 \note-mod "5" g'4
 \note-mod "6" a'4 |  \note-mod "1" c'4  \note-mod "4" f'4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 9: %}
 \note-mod "7" b'4
 ~  \note-mod "–" b'4 |  \note-mod "0" r4 |  \note-mod "2" d'4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 10: %}
 \note-mod "3" e'4
...
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "7" b'4
 ~ |  \note-mod "–" b'4  \note-mod "0" r4 | %{ bar 13: %}
 \note-mod "–" r4
 \note-mod "–" r4  \note-mod "–" r4  \note-mod "3" e'4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 14: %}
 \note-mod "2" d'4
 ~  \note-mod "–" d'4 |  \note-mod "4" f'4  \note-mod "5" g'4 | %{ bar 15: %}
 \note-mod "6" a'4
|  \note-mod "1" c'4  \note-mod "0" r4  \note-mod "7" b'4 \bar "|." } }
% === END JIANPU STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { e'4 f'2 | d'4  ~ | %{ bar 2: %} d'2 | g'4 a'4 | %{ bar 3: %} < c' >4 b'2.  ~ | %{ bar 4: %} b'4 r4 | r4 e'4 | %{ bar 5: %} f'2 | d'4 | g'4  ~ | %{ bar 6: %} g'4 | c'4 b'4 r4 | %{ bar 7: %} a'4 | d'4 e'2 | | %{ bar 8: %} g'4 a'4 | c'4 f'4 | %{ bar 9: %} b'2 | r4 | d'4 | %{ bar 10: %} e'2 | g'4 | a'4 | %{ bar 11: %} f'4  ~ | f'4 | c'2  ~ | %{ bar 12: %} c'4 | b'4  ~ | b'4 r4 | %{ bar 13: %} r2. e'4 | %{ bar 14: %} d'2 | f'4 g'4 | %{ bar 15: %} a'4 | c'4 r4 b'4 } }
% === END MIDI STAFF ===
