...
| |  \note-mod "0" r4  \note-mod "1" c'4  \note-mod "2" d'4 | %{ bar 3: %}
 \note-mod "3" e'4
 \note-mod "4" f'4  \note-mod "5" g'4  \note-mod "6" a'4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 4: %}
< \note-mod "7" b'  >4
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { | d'4 | | r4 c'4 f'4  ~ | %{ bar 2: %} f'4 | | r4 c'4 d'4 | %{ bar 3: %} e'4 f'4 g'4 a'4 | %{ bar 4: %} < b' >4  ~ | | | | < b' >2. | %{ bar 5: %} f'4 g'4  ~ | g'4 | e'4 | %{ bar 6: %} d'4 c'4 a'4  ~ | a'4 | %{ bar 7: %} r4 | | | | | r4 | | | | | r2 | %{ bar 8: %} R1 | %{ bar 9: %} r4 | r2. | %{ bar 10: %} R1 | %{ bar 11: %} R1 | %{ bar 12: %} R1 | %{ bar 13: %} r2. | r4 | %{ bar 14: %} R1 | %{ bar 15: %} R1 | %{ bar 16: %} R1 | %{ bar 17: %} r4 f'4 g'2 | | %{ bar 18: %} e'4 d'4 | a'4 c'4 | } }
% === END MIDI STAFF ===
