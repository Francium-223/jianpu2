...
\=JianpuTie(  ~ | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 8: %}
 \note-mod "1" c''4^. \=JianpuTie)
 ~  \note-mod "–" c''4 | %{ bar 9: %}
 \note-mod "3" e'4
 \note-mod "5" g'4 | | %{ bar 10: %}
 \note-mod "2" d'4
 \note-mod "4" f'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 11: %}
 \note-mod "6" a'4
 ~  \note-mod "–" a'4 | %{ bar 12: %}
 \note-mod "1" c'4
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "7" b'4
\=JianpuTie(  ~ \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 13: %}
...
|  \note-mod "–" r4 | %{ bar 25: %}
 ...
 \note-mod "–" r4 | %{ bar 35: %}
 \note-mod "–" r4
 \note-mod "2" d'4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 36: %}
 \note-mod "4" f'4
 ~  \note-mod "–" f'4 | %{ bar 37: %}
 \note-mod "3" e'4
|  \note-mod "5" g'4 | %{ bar 38: %}
 \note-mod "1" c'4
 \note-mod "6" a'4 | %{ bar 39: %}
 \note-mod "7" b'4
 \note-mod "0" r4 | \bar "|." } }
% === END JIANPU STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 d'4 e'4 | %{ bar 2: %} f'4 g'4 | %{ bar 3: %} c'4 b'4 | %{ bar 4: %} r4 a'4 | %{ bar 5: %} d'4 e'4 | %{ bar 6: %} f'4 g'4 | %{ bar 7: %} a'4 c''4  ~ | | %{ bar 8: %} c''2 | %{ bar 9: %} e'4 g'4 | | %{ bar 10: %} d'4 f'4 | | %{ bar 11: %} a'2 | %{ bar 12: %} c'4 b'4  ~ | %{ bar 13: %} b'2 | %{ bar 14: %} r4 | | | r4 | %{ bar 15: %} R2 | | | %{ bar 16: %} r4 | r4 | %{ bar 17: %} R2 | | %{ bar 18: %} R2 | %{ bar 19: %} R2 | %{ bar 20: %} R2 | %{ bar 21: %} R2 | | %{ bar 22: %} R2 | %{ bar 23: %} R2 | %{ bar 24: %} r4 | r4 | %{ bar 25: %} R2 | %{ bar 26: %} R2 | %{ bar 27: %} R2 | %{ bar 28: %} R2 | %{ bar 29: %} R2 | %{ bar 30: %} R2 | %{ bar 31: %} R2 | %{ bar 32: %} R2 | %{ bar 33: %} R2 | %{ bar 34: %} R2 | %{ bar 35: %} r4 d'4 | %{ bar 36: %} f'2 | %{ bar 37: %} e'4 | g'4 | %{ bar 38: %} c'4 a'4 | %{ bar 39: %} b'4 r4 | } }
% === END MIDI STAFF ===
