...
6 - 0 0 | 0 0 0 0 |
6 - 0 0
6 1' q2 3 q0 | 1 - 0 0 | 1 - 0 0 |
1' 0 0 0
6 0 0 0 | 0 0 0 0 |
1' q6 6 6 q0 | 0 0 0 0 |
5 6 - 0
2 - 0 0
0 0 0 0 | q3 - 0 0 q0 | q1 7 0 0 q0 |
6 0 0 0 | 0 0 0 0 |
q5 5 - 0 q0
3 - 0 0
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'2 r2 | | %{ bar 2: %} R1 | | %{ bar 3: %} a'2 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} a'2 r2 | %{ bar 6: %} a'4 c''4 d'8 e'4 r8 | | %{ bar 7: %} c'2 r2 | | %{ bar 8: %} c'2 r2 | | %{ bar 9: %} c''4 r2. | %{ bar 10: %} a'4 r2. | | %{ bar 11: %} R1 | | %{ bar 12: %} c''4 a'8 a'4 a'4 r8 | | %{ bar 13: %} R1 | | %{ bar 14: %} g'4 a'2 r4 | %{ bar 15: %} d'2 r2 | %{ bar 16: %} R1 | | %{ bar 17: %} e'8  ~ e'4 r2 r8 | | %{ bar 18: %} c'8 b'4 r2 r8 | | %{ bar 19: %} a'4 r2. | | %{ bar 20: %} R1 | | %{ bar 21: %} g'8 g'2 r4 r8 | %{ bar 22: %} e'2 r2 | %{ bar 23: %} R1 | | %{ bar 24: %} R1 | | %{ bar 25: %} c'4 r2. | } }
% === END MIDI STAFF ===
