...
%% === BEGIN JIANPU STAFF ===
 ...
 ~  \note-mod "–" e'4 | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 2: %}
 \note-mod "5" g'4
 ~  \note-mod "–" g'4 | | %{ bar 3: %}
 \note-mod "0" r4
 \note-mod "0" r4 | | %{ bar 4: %}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 e'2 | | %{ bar 2: %} g'2 | | %{ bar 3: %} R2 | | %{ bar 4: %} a'4 r4 | %{ bar 5: %} b'4 r4 | | %{ bar 6: %} R2 | | %{ bar 7: %} e'2 | | %{ bar 8: %} R2 | | %{ bar 9: %} c'4 r4 | | %{ bar 10: %} R2 | | %{ bar 11: %} r2 | } }
% === END MIDI STAFF ===
