...
4/4
3 2 - 6 | 1 2 0 0 | 0 0 0 0 |
q5 q7 q1' q2' 0 0 | 0 0 0 0 |
q0 q0 q0 q0 0 0 | 0 0 0 0 |
R{ } A{ }
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'4 d'2 a'4 | | %{ bar 2: %} c'4 d'4 r2 | | %{ bar 3: %} R1 | | %{ bar 4: %} g'8 b'8 c''8 d''8 r2 | | %{ bar 5: %} R1 | | %{ bar 6: %} r8 r8 r8 r8 r2 | | %{ bar 7: %} r1 | \repeat volta 2 { } \alternative { { }} } }
% === END MIDI STAFF ===
