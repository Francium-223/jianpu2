...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 c'4. d'4 e'4 r8 | | %{ bar 2: %} r4 a'4 a'4 b'4 | | %{ bar 3: %} b'4 b'4 a'4 b'4 | | %{ bar 4: %} c'4 d'4 r2 | | %{ bar 5: %} R1 | | %{ bar 6: %} R1 | | %{ bar 7: %} e'4.  ~ e'4 r4 r8 | | %{ bar 8: %} R1 | | %{ bar 9: %} r1 | } }
% === END MIDI STAFF ===
