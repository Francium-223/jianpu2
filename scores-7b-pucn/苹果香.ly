...
4/4
3 - q6 0 q0 | s2 q7 0 0 0 s0 | d1' d2' d1 0 - 0 q0 d0 | d5 d6 d7 - 0 0 q0 d0 | 0 0 0 0 |
b6 b7 b1' - | b5 b6 b7 - | b6 b7 b1' - |
%END
%}
...
\set stemRightBeamCount = #3
 \note-mod "6" a'32
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 \set stemLeftBeamCount = #3
\set stemRightBeamCount = #3
 \note-mod "7" b'32
]  ~  \note-mod "–" b'4  \note-mod "0" r4  \note-mod "0" r4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "1" \once \tweak Accidental.extra-offset #'(0 . 0.7)ces''4^.
 ~  \note-mod "–" ces''4 | | %{ bar 7: %}
 \note-mod "5" \once \tweak Accidental.extra-offset #'(0 . 0.7)ges'4
 \note-mod "6" \once \tweak Accidental.extra-offset #'(0 . 0.7)aes'4
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "7" \once \tweak Accidental.extra-offset #'(0 . 0.7)bes'4
 ~  \note-mod "–" bes'4 | | %{ bar 8: %}
 \note-mod "6" \once \tweak Accidental.extra-offset #'(0 . 0.7)aes'4
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'2 a'8 r4 r8 | | %{ bar 2: %} d'16 b'8 r2. r16 | | %{ bar 3: %} c''32 d''32 c'32 r2. r8 r32 | | %{ bar 4: %} g'32 a'32 b'32  ~ b'4 r2 r8 r32 | | %{ bar 5: %} R1 | | %{ bar 6: %} aes'4 bes'4 ces''2 | | %{ bar 7: %} ges'4 aes'4 bes'2 | | %{ bar 8: %} aes'4 bes'4 ces''2 | } }
% === END MIDI STAFF ===
