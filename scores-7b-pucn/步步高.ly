...
| | %{ bar 6: %}
 \note-mod "0" r4
 \note-mod "0" r4 | \repeat volta 2 { } \alternative { { | %{ bar 7: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "6" a'8[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 r4 e'8 r8 | | %{ bar 2: %} R2 | | %{ bar 3: %} g'8 b'8 r4 | | %{ bar 4: %} R2 | | %{ bar 5: %} c'8  ~ c'4 r8 | | %{ bar 6: %} r2 | \repeat volta 2 { } \alternative { { | %{ bar 7: %} a'8 c''8 r4 }} } }
% === END MIDI STAFF ===
