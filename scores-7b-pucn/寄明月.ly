...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 d'4 e'2 r4 | | %{ bar 2: %} r2 a'2 | | %{ bar 3: %} R1 | | %{ bar 4: %} g'2 b'2  ~ | | %{ bar 5: %} b'4 c''4 d''4 r4 | | %{ bar 6: %} R1 | | %{ bar 7: %} c''4 d''2 r4 | | %{ bar 8: %} e''2 f''4 r4 | | %{ bar 9: %} R1 | | %{ bar 10: %} g'2 a'2  ~ | | %{ bar 11: %} a'4 b'4 c''4 r4 | | %{ bar 12: %} R1 | | %{ bar 13: %} c''4 d''2 r4 | | %{ bar 14: %} r4 e'4 f'4 r4 | | %{ bar 15: %} R1 | | %{ bar 16: %} g'2 a'2  ~ | | %{ bar 17: %} a'4 b'4 c''4 r4 | | %{ bar 18: %} r1 | } }
% === END MIDI STAFF ===
