...
%% === BEGIN JIANPU STAFF ===
 ...
 ~  \note-mod "–" c'4 | | %{ bar 2: %} \set stemLeftBeamCount = #0
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 e'4 d'4 c'2 | | %{ bar 2: %} a'8 g'4 b'8  ~ b'4 r4 | | %{ bar 3: %} R1 | | %{ bar 4: %} c''8 d''4 r8 r2 | | %{ bar 5: %} r1 | } }
% === END MIDI STAFF ===
