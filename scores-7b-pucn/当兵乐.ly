...
4/4
0 0 0 0 | 5 - 6 1' | 2 0 0 0 | 1' 3 q2 q2 0 | 1' 2 q1 q7 0 | q1' 0 0 0 q0 | 0 0 0 0 |
5 - 6 1' | 2 0 0 0 | 1' 3 q2 q2 0 | 1' 2 q1 q7 0 | q1' 0 0 0 q0 |
4 0 2' - | 5 - 6 1' | 2 0 0 0 | 1' 3 q2 q2 0 | 1' 2 q1 q7 0 | q1' 0 0 0 q0 | 0 0 0 0 |
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 r1 | | %{ bar 2: %} g'2 a'4 c''4 | | %{ bar 3: %} d'4 r2. | | %{ bar 4: %} c''4 e'4 d'8 d'8 r4 | | %{ bar 5: %} c''4 d'4 c'8 b'8 r4 | | %{ bar 6: %} c''8 r2. r8 | | %{ bar 7: %} R1 | | %{ bar 8: %} g'2 a'4 c''4 | | %{ bar 9: %} d'4 r2. | | %{ bar 10: %} c''4 e'4 d'8 d'8 r4 | | %{ bar 11: %} c''4 d'4 c'8 b'8 r4 | | %{ bar 12: %} c''8 r2. r8 | | %{ bar 13: %} f'4 r4 d''2 | | %{ bar 14: %} g'2 a'4 c''4 | | %{ bar 15: %} d'4 r2. | | %{ bar 16: %} c''4 e'4 d'8 d'8 r4 | | %{ bar 17: %} c''4 d'4 c'8 b'8 r4 | | %{ bar 18: %} c''8 r2. r8 | | %{ bar 19: %} r1 | } }
% === END MIDI STAFF ===
