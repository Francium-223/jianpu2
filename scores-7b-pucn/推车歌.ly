...
6 - 5 - | 0 0 0 0 |
2 q3 0 0 q0 | 0 0 0 0 |
q7 q1' q2' 0 0 q0 | 0 0 0 0 |
1 0 1 0 | 1. 0 0 q0
0 0 0 0 | 1 2 1 0 | 3. 0 0 q0 |
R{ }
%END
%}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'2 g'2 | | %{ bar 2: %} R1 | | %{ bar 3: %} d'4 e'8 r2 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} b'8 c''8 d''8 r2 r8 | | %{ bar 6: %} R1 | | %{ bar 7: %} c'4 r4 c'4 r4 | | %{ bar 8: %} c'4. r2 r8 | %{ bar 9: %} R1 | | %{ bar 10: %} c'4 d'4 c'4 r4 | | %{ bar 11: %} e'4. r2 r8 | \repeat volta 2 { } } }
% === END MIDI STAFF ===
