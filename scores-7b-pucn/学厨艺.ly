...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 2/4 g'2 | | %{ bar 2: %} a'4 r4 | | %{ bar 3: %} R2 | | %{ bar 4: %} e'4 r4 | | %{ bar 5: %} R2 | | %{ bar 6: %} c'4 d'4 | | %{ bar 7: %} f'4 r4 | %{ bar 8: %} g'2 | | %{ bar 9: %} a'4 r4 | | %{ bar 10: %} R2 | | %{ bar 11: %} e'4 r4 | | %{ bar 12: %} R2 | | %{ bar 13: %} c'4 d'4 | | %{ bar 14: %} f'4 r4 } }
% === END MIDI STAFF ===
