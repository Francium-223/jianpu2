...
4/4
5 - 2 0 | 3 6 0 0 | 7 - 0 0 | - 0 0 0 | - 0 0 0 |
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 g'2 d'4 r4 | | %{ bar 2: %} e'4 a'4 r2 | | %{ bar 3: %} b'2 r2 | | %{ bar 4: %} R1 | | %{ bar 5: %} R1 | | %{ bar 6: %} c'4 d'4 e'4 r4 | | %{ bar 7: %} R1 | | %{ bar 8: %} R1 | | %{ bar 9: %} g'2 r2 | | %{ bar 10: %} R1 | | %{ bar 11: %} g'4 c''4 r2 | | %{ bar 12: %} a'4 b'4 r2 | | %{ bar 13: %} R1 | | %{ bar 14: %} R1 | | %{ bar 15: %} e'4 f'4 r2 | | %{ bar 16: %} R1 | | %{ bar 17: %} r1 | } }
% === END MIDI STAFF ===
