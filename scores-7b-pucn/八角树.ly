...
q5 - 0 0 q0 | 0 0 0 0 |
q7 q1 q1' 0 0 q0 | 0 0 0 0 |
q2' 0 0 0 q0
q2 s3 0 0 0 s0 | 0 0 0 0 |
q5 - 0 0 q0
q7 q1 q1' 0 0 q0 | 0 0 0 0 |
q2' 0 0 0 q0
%END
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'4 d'8 e'16 r2 r16 | | %{ bar 2: %} R1 | | %{ bar 3: %} g'8  ~ g'4 r2 r8 | | %{ bar 4: %} R1 | | %{ bar 5: %} b'8 c'8 c''8 r2 r8 | | %{ bar 6: %} R1 | | %{ bar 7: %} d''8 r2. r8 | %{ bar 8: %} d'8 e'16 r2. r16 | | %{ bar 9: %} R1 | | %{ bar 10: %} g'8  ~ g'4 r2 r8 | %{ bar 11: %} b'8 c'8 c''8 r2 r8 | | %{ bar 12: %} R1 | | %{ bar 13: %} d''8 r2. r8 } }
% === END MIDI STAFF ===
