...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'2 r2 | | %{ bar 2: %} d'4 e'8  ~ e'4 r4 r8 | | %{ bar 3: %} R1 | | %{ bar 4: %} b'4 ges'2 r4 | | %{ bar 5: %} R1 | | %{ bar 6: %} R1 | | %{ bar 7: %} R1 | | %{ bar 8: %} R1 | | %{ bar 9: %} R1 | | %{ bar 10: %} r1 | } }
% === END MIDI STAFF ===
