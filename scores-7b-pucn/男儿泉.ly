...
4/4
6 - q7 0 q0 | 1' 0 q3 0 q0 | ,2 q3 - 0 q0 | q1 q0 q3 0 0 q0 | 1'. 7 5 q0 | 3 0 0 0 | - 0 0 0 |
q1' 0 0 0 q0 | q1 q1 q1 0 0 q0 | q3 0 0 0 q0 | - 0 0 0 | q0 q3 q3 0 0 q0 | ,6 - q6 - q0 | 1' 0 0 0 | 7 6., 2 q0 | - 0 0 0 |
4 0 0 0 | q0 q3 q5 0 0 q0 | ,2 - - 0 | q0 q2 q3 0 0 q0 | 1'. - . q0 | 0 0 0 0 |
,q0 q3 q5 0 0 q0 | 1' - . 0 | - 0 0 0 |
q1 1' 0 0 q0 | q0 q6 q3 0 0 q0 | ,2 - - 0 | 0 7 - 1' | 7., ,7 - q0 | - 0 0 0 |
4 2' 0 0 | q0 q6 q7. 0 0 s0 | - 0 0 0 |
q1 7 0 0 q0 | 1'. - . q0 | 0 0 0 0 |
,q0 q6 q7 0 0 q0 | 1' - - 1' | - . 0 0 | - 0 0 0 |
%END
%}
...
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 13: %}
 ...
 ~  \note-mod "–" a4 \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "6" a'8[
]  ~  \note-mod "–" a'4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
\set stemRightBeamCount = #1
 \note-mod "0" c8-\tweak #'X-offset #0.6 _. [
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
 \note-mod "3" e'8]
\set stemLeftBeamCount = #0
...
| \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 28: %}
 ...
 \note-mod "0" r4
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "7" b'4
 ~  \note-mod "–" b'4  \note-mod "1" c''4^. | | %{ bar 30: %}
 \note-mod "7" b4.-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
\once \override Tie.transparent = ##t \once \override Tie.staff-position = #0  \note-mod "7" b4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" b4 \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "0" c'8[]
| | %{ bar 31: %}
 \note-mod "–" r4
...
\=JianpuTie(  ~ | \once \override Tie.transparent = ##t \once \override Tie.staff-position = #0 | %{ bar 40: %}
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \time 4/4 a'2 b'8 r4 r8 | | %{ bar 2: %} c''4 r4 e'8 r4 r8 | | %{ bar 3: %} d4 e'8  ~ e'4 r4 r8 | | %{ bar 4: %} c'8 r8 e'8 r2 r8 | | %{ bar 5: %} c''4. b'4 g'4 r8 | | %{ bar 6: %} e'4 r2. | | %{ bar 7: %} R1 | | %{ bar 8: %} c''8 r2. r8 | | %{ bar 9: %} c'8 c'8 c'8 r2 r8 | | %{ bar 10: %} e'8 r2. r8 | | %{ bar 11: %} R1 | | %{ bar 12: %} r8 e'8 e'8 r2 r8 | | %{ bar 13: %} a2 a'8  ~ a'4 r8 | | %{ bar 14: %} c''4 r2. | | %{ bar 15: %} b'4 a4. d'4 r8 | | %{ bar 16: %} R1 | | %{ bar 17: %} f'4 r2. | | %{ bar 18: %} r8 e'8 g'8 r2 r8 | | %{ bar 19: %} d2. r4 | | %{ bar 20: %} r8 d'8 e'8 r2 r8 | | %{ bar 21: %} c''4.  ~ c''2 r8 | | %{ bar 22: %} R1 | | %{ bar 23: %} r8 e'8 g'8 r2 r8 | | %{ bar 24: %} c''2. r4 | | %{ bar 25: %} R1 | | %{ bar 26: %} c'8 c''4 r2 r8 | | %{ bar 27: %} r8 a'8 e'8 r2 r8 | | %{ bar 28: %} d2. r4 | | %{ bar 29: %} r4 b'2 c''4 | | %{ bar 30: %} b4. b2 r8 | | %{ bar 31: %} R1 | | %{ bar 32: %} f'4 d''4 r2 | | %{ bar 33: %} r8 a'8 b'8. r2 r16 | | %{ bar 34: %} R1 | | %{ bar 35: %} c'8 b'4 r2 r8 | | %{ bar 36: %} c''4.  ~ c''2 r8 | | %{ bar 37: %} R1 | | %{ bar 38: %} r8 a'8 b'8 r2 r8 | | %{ bar 39: %} c''2. c''4  ~ | | %{ bar 40: %} c''2 r2 | | %{ bar 41: %} r1 | } }
% === END MIDI STAFF ===
